...
#ifdef _DEBUG
    PS_LOG_ENTRY("_doMC_0x121828");
#endif

    ctx->pc = 0x121828u;

label_121828:
    // 0x121828: 0x27bdff90  addiu       $sp, $sp, -0x70
    ctx->pc = 0x121828u;
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 4294967184));
label_12182c:
    // 0x12182c: 0x24020140  addiu       $v0, $zero, 0x140
    ctx->pc = 0x12182cu;
    SET_GPR_S32(ctx, 2, (int32_t)ADD32(GPR_U32(ctx, 0), 320));
label_121830:
    // 0x121830: 0xffb40040  sd          $s4, 0x40($sp)
    ctx->pc = 0x121830u;
    WRITE64(ADD32(GPR_U32(ctx, 29), 64), GPR_U64(ctx, 20));
label_121834:
    // 0x121834: 0x80a02d  daddu       $s4, $a0, $zero
    ctx->pc = 0x121834u;
    SET_GPR_U64(ctx, 20, (uint64_t)GPR_U64(ctx, 4) + (uint64_t)GPR_U64(ctx, 0));
label_121838:
    // 0x121838: 0xffb50050  sd          $s5, 0x50($sp)
    ctx->pc = 0x121838u;
    WRITE64(ADD32(GPR_U32(ctx, 29), 80), GPR_U64(ctx, 21));
label_12183c:
    // 0x12183c: 0x2822818  mult        $a1, $s4, $v0
    ctx->pc = 0x12183cu;
...
label_121840:
    // 0x121840: 0x3c150017  lui         $s5, 0x17
    ctx->pc = 0x121840u;
    SET_GPR_S32(ctx, 21, (int32_t)((uint32_t)23 << 16));
label_121844:
    // 0x121844: 0xffbf0060  sd          $ra, 0x60($sp)
    ctx->pc = 0x121844u;
    WRITE64(ADD32(GPR_U32(ctx, 29), 96), GPR_U64(ctx, 31));
label_121848:
    // 0x121848: 0x26a41df8  addiu       $a0, $s5, 0x1DF8
    ctx->pc = 0x121848u;
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 21), 7672));
label_12184c:
    // 0x12184c: 0xffb30030  sd          $s3, 0x30($sp)
    ctx->pc = 0x12184cu;
    WRITE64(ADD32(GPR_U32(ctx, 29), 48), GPR_U64(ctx, 19));
label_121850:
    // 0x121850: 0xffb20020  sd          $s2, 0x20($sp)
    ctx->pc = 0x121850u;
    WRITE64(ADD32(GPR_U32(ctx, 29), 32), GPR_U64(ctx, 18));
label_121854:
    // 0x121854: 0xffb10010  sd          $s1, 0x10($sp)
    ctx->pc = 0x121854u;
    WRITE64(ADD32(GPR_U32(ctx, 29), 16), GPR_U64(ctx, 17));
label_121858:
    // 0x121858: 0x851021  addu        $v0, $a0, $a1
    ctx->pc = 0x121858u;
    SET_GPR_S32(ctx, 2, (int32_t)ADD32(GPR_U32(ctx, 4), GPR_U32(ctx, 5)));
label_12185c:
    // 0x12185c: 0xffb00000  sd          $s0, 0x0($sp)
    ctx->pc = 0x12185cu;
    WRITE64(ADD32(GPR_U32(ctx, 29), 0), GPR_U64(ctx, 16));
label_121860:
    // 0x121860: 0x8c430138  lw          $v1, 0x138($v0)
    ctx->pc = 0x121860u;
    SET_GPR_S32(ctx, 3, (int32_t)READ32(ADD32(GPR_U32(ctx, 2), 312)));
label_121864:
    // 0x121864: 0x10600018  beqz        $v1, . + 4 + (0x18 << 2)
label_121868:
    if (ctx->pc == 0x121868u) {
        ctx->pc = 0x121868u;
            // 0x121868: 0x2483012c  addiu       $v1, $a0, 0x12C (Delay Slot)
        SET_GPR_S32(ctx, 3, (int32_t)ADD32(GPR_U32(ctx, 4), 300));
        ctx->pc = 0x12186Cu;
        goto label_12186c;
    }
    ctx->pc = 0x121864u;
    {
        const bool branch_taken_0x121864 = (GPR_U64(ctx, 3) == GPR_U64(ctx, 0));
        ctx->pc = 0x121868u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x121864u;
            // 0x121868: 0x2483012c  addiu       $v1, $a0, 0x12C (Delay Slot)
        SET_GPR_S32(ctx, 3, (int32_t)ADD32(GPR_U32(ctx, 4), 300));
    ...
    ctx->pc = 0x12186Cu;
label_12186c:
    // 0x12186c: 0xa33021  addu        $a2, $a1, $v1
    ctx->pc = 0x12186cu;
    SET_GPR_S32(ctx, 6, (int32_t)ADD32(GPR_U32(ctx, 5), GPR_U32(ctx, 3)));
label_121870:
    // 0x121870: 0x8cc20000  lw          $v0, 0x0($a2)
    ctx->pc = 0x121870u;
    SET_GPR_S32(ctx, 2, (int32_t)READ32(ADD32(GPR_U32(ctx, 6), 0)));
label_121874:
    // 0x121874: 0x18400014  blez        $v0, . + 4 + (0x14 << 2)
label_121878:
    if (ctx->pc == 0x121878u) {
        ctx->pc = 0x121878u;
            // 0x121878: 0x902d  daddu       $s2, $zero, $zero (Delay Slot)
    ...
    ctx->pc = 0x121874u;
    {
        ...
        ctx->pc = 0x121878u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x121874u;
            // 0x121878: 0x902d  daddu       $s2, $zero, $zero (Delay Slot)
        SET_GPR_U64(ctx, 18, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
        ctx->in_delay_slot = false;
...
label_121894:
    ...
    // NOP
label_121898:
    // 0x121898: 0x220202d  daddu       $a0, $s1, $zero
    ctx->pc = 0x121898u;
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 17) + (uint64_t)GPR_U64(ctx, 0));
label_12189c:
    // 0x12189c: 0x40f809  jalr        $v0
label_1218a0:
    if (ctx->pc == 0x1218A0u) {
        ctx->pc = 0x1218A0u;
            // 0x1218a0: 0x26520001  addiu       $s2, $s2, 0x1 (Delay Slot)
    ...
    ctx->pc = 0x12189Cu;
    {
        ...
        ctx->pc = 0x1218A0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x12189Cu;
            // 0x1218a0: 0x26520001  addiu       $s2, $s2, 0x1 (Delay Slot)
        SET_GPR_S32(ctx, 18, (int32_t)ADD32(GPR_U32(ctx, 18), 1));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
    ...
    ctx->pc = 0x1218A4u;
label_1218a4:
    // 0x1218a4: 0x8e030000  lw          $v1, 0x0($s0)
    ctx->pc = 0x1218a4u;
    SET_GPR_S32(ctx, 3, (int32_t)READ32(ADD32(GPR_U32(ctx, 16), 0)));
label_1218a8:
    // 0x1218a8: 0x26240070  addiu       $a0, $s1, 0x70
    ctx->pc = 0x1218a8u;
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 17), 112));
label_1218ac:
    // 0x1218ac: 0x26100004  addiu       $s0, $s0, 0x4
    ctx->pc = 0x1218acu;
    SET_GPR_S32(ctx, 16, (int32_t)ADD32(GPR_U32(ctx, 16), 4));
label_1218b0:
    // 0x1218b0: 0x60f809  jalr        $v1
label_1218b4:
    if (ctx->pc == 0x1218B4u) {
        ctx->pc = 0x1218B4u;
            // 0x1218b4: 0x2631001c  addiu       $s1, $s1, 0x1C (Delay Slot)
    ...
    ctx->pc = 0x1218B0u;
    {
        ...
        ctx->pc = 0x1218B4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1218B0u;
            // 0x1218b4: 0x2631001c  addiu       $s1, $s1, 0x1C (Delay Slot)
        SET_GPR_S32(ctx, 17, (int32_t)ADD32(GPR_U32(ctx, 17), 28));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
    ...
    ctx->pc = 0x1218B8u;
label_1218b8:
    // 0x1218b8: 0x8e620000  lw          $v0, 0x0($s3)
    ctx->pc = 0x1218b8u;
    SET_GPR_S32(ctx, 2, (int32_t)READ32(ADD32(GPR_U32(ctx, 19), 0)));
label_1218bc:
    // 0x1218bc: 0x242102a  slt         $v0, $s2, $v0
    ctx->pc = 0x1218bcu;
    SET_GPR_U64(ctx, 2, ((int64_t)GPR_S64(ctx, 18) < (int64_t)GPR_S64(ctx, 2)) ? 1 : 0);
label_1218c0:
    // 0x1218c0: 0x5440fff5  bnel        $v0, $zero, . + 4 + (-0xB << 2)
label_1218c4:
    if (ctx->pc == 0x1218C4u) {
        ctx->pc = 0x1218C4u;
            // 0x1218c4: 0x8e02fff0  lw          $v0, -0x10($s0) (Delay Slot)
        SET_GPR_S32(ctx, 2, (int32_t)READ32(ADD32(GPR_U32(ctx, 16), 4294967280)));
        ctx->pc = 0x1218C8u;
        goto label_1218c8;
    }
    ctx->pc = 0x1218C0u;
    {
        const bool branch_taken_0x1218c0 = (GPR_U64(ctx, 2) != GPR_U64(ctx, 0));
        if (branch_taken_0x1218c0) {
            ctx->pc = 0x1218C4u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x1218C0u;
            // 0x1218c4: 0x8e02fff0  lw          $v0, -0x10($s0) (Delay Slot)
        SET_GPR_S32(ctx, 2, (int32_t)READ32(ADD32(GPR_U32(ctx, 16), 4294967280)));
        ctx->in_delay_slot = false;
            ctx->pc = 0x121898u;
    ...
    ctx->pc = 0x1218C8u;
label_1218c8:
    // 0x1218c8: 0x24030140  addiu       $v1, $zero, 0x140
    ctx->pc = 0x1218c8u;
    SET_GPR_S32(ctx, 3, (int32_t)ADD32(GPR_U32(ctx, 0), 320));
label_1218cc:
    // 0x1218cc: 0x26a51df8  addiu       $a1, $s5, 0x1DF8
    ctx->pc = 0x1218ccu;
    SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 21), 7672));
label_1218d0:
    // 0x1218d0: 0x2832018  mult        $a0, $s4, $v1
    ctx->pc = 0x1218d0u;
    { int64_t result = (int64_t)GPR_S32(ctx, 20) * (int64_t)GPR_S32(ctx, 3); ctx->lo = (uint64_t)(int64_t)(int32_t)result; ctx->hi = (uint64_t)(int64_t)(int32_t)(result >> 32); }
label_1218d4:
    // 0x1218d4: 0xa41021  addu        $v0, $a1, $a0
    ctx->pc = 0x1218d4u;
    SET_GPR_S32(ctx, 2, (int32_t)ADD32(GPR_U32(ctx, 5), GPR_U32(ctx, 4)));
label_1218d8:
    // 0x1218d8: 0x8c430130  lw          $v1, 0x130($v0)
    ctx->pc = 0x1218d8u;
    SET_GPR_S32(ctx, 3, (int32_t)READ32(ADD32(GPR_U32(ctx, 2), 304)));
label_1218dc:
    // 0x1218dc: 0x10600008  beqz        $v1, . + 4 + (0x8 << 2)
label_1218e0:
    if (ctx->pc == 0x1218E0u) {
        ctx->pc = 0x1218E0u;
            // 0x1218e0: 0x24030140  addiu       $v1, $zero, 0x140 (Delay Slot)
        SET_GPR_S32(ctx, 3, (int32_t)ADD32(GPR_U32(ctx, 0), 320));
        ctx->pc = 0x1218E4u;
        goto label_1218e4;
    }
    ctx->pc = 0x1218DCu;
    {
        const bool branch_taken_0x1218dc = (GPR_U64(ctx, 3) == GPR_U64(ctx, 0));
        ctx->pc = 0x1218E0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1218DCu;
            // 0x1218e0: 0x24030140  addiu       $v1, $zero, 0x140 (Delay Slot)
        SET_GPR_S32(ctx, 3, (int32_t)ADD32(GPR_U32(ctx, 0), 320));
        ctx->in_delay_slot = false;
    ...
    ctx->pc = 0x1218E4u;
label_1218e4:
    // 0x1218e4: 0x8c43013c  lw          $v1, 0x13C($v0)
    ctx->pc = 0x1218e4u;
    SET_GPR_S32(ctx, 3, (int32_t)READ32(ADD32(GPR_U32(ctx, 2), 316)));
label_1218e8:
    // 0x1218e8: 0x10600003  beqz        $v1, . + 4 + (0x3 << 2)
label_1218ec:
    if (ctx->pc == 0x1218ECu) {
        ctx->pc = 0x1218ECu;
            // 0x1218ec: 0x3c040017  lui         $a0, 0x17 (Delay Slot)
    ...
    ctx->pc = 0x1218E8u;
    {
        const bool branch_taken_0x1218e8 = (GPR_U64(ctx, 3) == GPR_U64(ctx, 0));
        ctx->pc = 0x1218ECu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1218E8u;
            // 0x1218ec: 0x3c040017  lui         $a0, 0x17 (Delay Slot)
        SET_GPR_S32(ctx, 4, (int32_t)((uint32_t)23 << 16));
        ctx->in_delay_slot = false;
    ...
    ctx->pc = 0x1218F0u;
label_1218f0:
    // 0x1218f0: 0xc048006  jal         func_120018
label_1218f4:
    if (ctx->pc == 0x1218F4u) {
        ctx->pc = 0x1218F4u;
            // 0x1218f4: 0x24844e88  addiu       $a0, $a0, 0x4E88 (Delay Slot)
        SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 4), 20104));
        ctx->pc = 0x1218F8u;
        goto label_1218f8;
    }
    ctx->pc = 0x1218F0u;
    ...
    ctx->pc = 0x1218F8u;
label_1218f8:
    // 0x1218f8: 0x24030140  addiu       $v1, $zero, 0x140
    ctx->pc = 0x1218f8u;
    SET_GPR_S32(ctx, 3, (int32_t)ADD32(GPR_U32(ctx, 0), 320));
label_1218fc:
    // 0x1218fc: 0x26a51df8  addiu       $a1, $s5, 0x1DF8
    ctx->pc = 0x1218fcu;
    SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 21), 7672));
label_121900:
    // 0x121900: 0x2832018  mult        $a0, $s4, $v1
    ctx->pc = 0x121900u;
    { int64_t result = (int64_t)GPR_S32(ctx, 20) * (int64_t)GPR_S32(ctx, 3); ctx->lo = (uint64_t)(int64_t)(int32_t)result; ctx->hi = (uint64_t)(int64_t)(int32_t)(result >> 32); }
label_121904:
    // 0x121904: 0xa41021  addu        $v0, $a1, $a0
    ctx->pc = 0x121904u;
    SET_GPR_S32(ctx, 2, (int32_t)ADD32(GPR_U32(ctx, 5), GPR_U32(ctx, 4)));
label_121908:
    // 0x121908: 0x8c430130  lw          $v1, 0x130($v0)
    ctx->pc = 0x121908u;
    SET_GPR_S32(ctx, 3, (int32_t)READ32(ADD32(GPR_U32(ctx, 2), 304)));
label_12190c:
    // 0x12190c: 0x5060000d  beql        $v1, $zero, . + 4 + (0xD << 2)
label_121910:
    if (ctx->pc == 0x121910u) {
        ctx->pc = 0x121910u;
            // 0x121910: 0x8c43013c  lw          $v1, 0x13C($v0) (Delay Slot)
        SET_GPR_S32(ctx, 3, (int32_t)READ32(ADD32(GPR_U32(ctx, 2), 316)));
        ctx->pc = 0x121914u;
        goto label_121914;
    }
    ctx->pc = 0x12190Cu;
    {
        const bool branch_taken_0x12190c = (GPR_U64(ctx, 3) == GPR_U64(ctx, 0));
        if (branch_taken_0x12190c) {
            ctx->pc = 0x121910u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x12190Cu;
            // 0x121910: 0x8c43013c  lw          $v1, 0x13C($v0) (Delay Slot)
        SET_GPR_S32(ctx, 3, (int32_t)READ32(ADD32(GPR_U32(ctx, 2), 316)));
        ctx->in_delay_slot = false;
            ctx->pc = 0x121944u;
    ...
    ctx->pc = 0x121914u;
label_121914:
    // 0x121914: 0x40182d  daddu       $v1, $v0, $zero
    ctx->pc = 0x121914u;
    SET_GPR_U64(ctx, 3, (uint64_t)GPR_U64(ctx, 2) + (uint64_t)GPR_U64(ctx, 0));
label_121918:
    // 0x121918: 0x8c440128  lw          $a0, 0x128($v0)
    ctx->pc = 0x121918u;
    SET_GPR_S32(ctx, 4, (int32_t)READ32(ADD32(GPR_U32(ctx, 2), 296)));
label_12191c:
    // 0x12191c: 0x8c650004  lw          $a1, 0x4($v1)
    ctx->pc = 0x12191cu;
    SET_GPR_S32(ctx, 5, (int32_t)READ32(ADD32(GPR_U32(ctx, 3), 4)));
label_121920:
    // 0x121920: 0xdfbf0060  ld          $ra, 0x60($sp)
    ctx->pc = 0x121920u;
    SET_GPR_U64(ctx, 31, READ64(ADD32(GPR_U32(ctx, 29), 96)));
label_121924:
    // 0x121924: 0xdfb50050  ld          $s5, 0x50($sp)
    ctx->pc = 0x121924u;
    SET_GPR_U64(ctx, 21, READ64(ADD32(GPR_U32(ctx, 29), 80)));
label_121928:
    // 0x121928: 0xdfb40040  ld          $s4, 0x40($sp)
    ctx->pc = 0x121928u;
    SET_GPR_U64(ctx, 20, READ64(ADD32(GPR_U32(ctx, 29), 64)));
label_12192c:
    // 0x12192c: 0xdfb30030  ld          $s3, 0x30($sp)
    ctx->pc = 0x12192cu;
    SET_GPR_U64(ctx, 19, READ64(ADD32(GPR_U32(ctx, 29), 48)));
label_121930:
    // 0x121930: 0xdfb20020  ld          $s2, 0x20($sp)
    ctx->pc = 0x121930u;
    SET_GPR_U64(ctx, 18, READ64(ADD32(GPR_U32(ctx, 29), 32)));
label_121934:
    // 0x121934: 0xdfb10010  ld          $s1, 0x10($sp)
    ctx->pc = 0x121934u;
    SET_GPR_U64(ctx, 17, READ64(ADD32(GPR_U32(ctx, 29), 16)));
label_121938:
    // 0x121938: 0xdfb00000  ld          $s0, 0x0($sp)
    ctx->pc = 0x121938u;
    SET_GPR_U64(ctx, 16, READ64(ADD32(GPR_U32(ctx, 29), 0)));
label_12193c:
    // 0x12193c: 0x80489ca  j           func_122728
label_121940:
    if (ctx->pc == 0x121940u) {
        ctx->pc = 0x121940u;
            // 0x121940: 0x27bd0070  addiu       $sp, $sp, 0x70 (Delay Slot)
    ...
    ctx->pc = 0x12193Cu;
    ctx->pc = 0x121940u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x12193Cu;
            // 0x121940: 0x27bd0070  addiu       $sp, $sp, 0x70 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 112));
        ctx->in_delay_slot = false;
    ctx->pc = 0x122728u;
    if (runtime->hasFunction(0x122728u)) {
        auto targetFn = runtime->lookupFunction(0x122728u);
    ...
    ctx->pc = 0x121944u;
label_121944:
    // 0x121944: 0x5060000d  beql        $v1, $zero, . + 4 + (0xD << 2)
label_121948:
    if (ctx->pc == 0x121948u) {
        ctx->pc = 0x121948u;
            // 0x121948: 0xa41021  addu        $v0, $a1, $a0 (Delay Slot)
        SET_GPR_S32(ctx, 2, (int32_t)ADD32(GPR_U32(ctx, 5), GPR_U32(ctx, 4)));
        ctx->pc = 0x12194Cu;
        goto label_12194c;
    }
    ctx->pc = 0x121944u;
    {
        const bool branch_taken_0x121944 = (GPR_U64(ctx, 3) == GPR_U64(ctx, 0));
        if (branch_taken_0x121944) {
            ctx->pc = 0x121948u;
            ctx->in_delay_slot = true; ctx->branch_pc = 0x121944u;
            // 0x121948: 0xa41021  addu        $v0, $a1, $a0 (Delay Slot)
        SET_GPR_S32(ctx, 2, (int32_t)ADD32(GPR_U32(ctx, 5), GPR_U32(ctx, 4)));
        ctx->in_delay_slot = false;
            ctx->pc = 0x12197Cu;
    ...
    ctx->pc = 0x12194Cu;
label_12194c:
    // 0x12194c: 0x3c030017  lui         $v1, 0x17
    ctx->pc = 0x12194cu;
    SET_GPR_S32(ctx, 3, (int32_t)((uint32_t)23 << 16));
label_121950:
    // 0x121950: 0x8c440128  lw          $a0, 0x128($v0)
    ctx->pc = 0x121950u;
    SET_GPR_S32(ctx, 4, (int32_t)READ32(ADD32(GPR_U32(ctx, 2), 296)));
label_121954:
    // 0x121954: 0x8c6517b8  lw          $a1, 0x17B8($v1)
    ctx->pc = 0x121954u;
    SET_GPR_S32(ctx, 5, (int32_t)READ32(ADD32(GPR_U32(ctx, 3), 6072)));
label_121958:
    // 0x121958: 0xdfbf0060  ld          $ra, 0x60($sp)
    ctx->pc = 0x121958u;
    SET_GPR_U64(ctx, 31, READ64(ADD32(GPR_U32(ctx, 29), 96)));
label_12195c:
    // 0x12195c: 0xdfb50050  ld          $s5, 0x50($sp)
    ctx->pc = 0x12195cu;
    SET_GPR_U64(ctx, 21, READ64(ADD32(GPR_U32(ctx, 29), 80)));
label_121960:
    // 0x121960: 0xdfb40040  ld          $s4, 0x40($sp)
    ctx->pc = 0x121960u;
    SET_GPR_U64(ctx, 20, READ64(ADD32(GPR_U32(ctx, 29), 64)));
label_121964:
    // 0x121964: 0xdfb30030  ld          $s3, 0x30($sp)
    ctx->pc = 0x121964u;
    SET_GPR_U64(ctx, 19, READ64(ADD32(GPR_U32(ctx, 29), 48)));
label_121968:
    // 0x121968: 0xdfb20020  ld          $s2, 0x20($sp)
    ctx->pc = 0x121968u;
    SET_GPR_U64(ctx, 18, READ64(ADD32(GPR_U32(ctx, 29), 32)));
label_12196c:
    // 0x12196c: 0xdfb10010  ld          $s1, 0x10($sp)
    ctx->pc = 0x12196cu;
    SET_GPR_U64(ctx, 17, READ64(ADD32(GPR_U32(ctx, 29), 16)));
label_121970:
    // 0x121970: 0xdfb00000  ld          $s0, 0x0($sp)
    ctx->pc = 0x121970u;
    SET_GPR_U64(ctx, 16, READ64(ADD32(GPR_U32(ctx, 29), 0)));
label_121974:
    // 0x121974: 0x80489ca  j           func_122728
label_121978:
    if (ctx->pc == 0x121978u) {
        ctx->pc = 0x121978u;
            // 0x121978: 0x27bd0070  addiu       $sp, $sp, 0x70 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 112));
        ctx->pc = 0x12197Cu;
        goto label_12197c;
    }
    ctx->pc = 0x121974u;
    ctx->pc = 0x121978u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x121974u;
            // 0x121978: 0x27bd0070  addiu       $sp, $sp, 0x70 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 112));
        ctx->in_delay_slot = false;
    ctx->pc = 0x122728u;
    ...
    ctx->pc = 0x12197Cu;
label_12197c:
    // 0x12197c: 0x3c060017  lui         $a2, 0x17
    ctx->pc = 0x12197cu;
    SET_GPR_S32(ctx, 6, (int32_t)((uint32_t)23 << 16));
label_121980:
    // 0x121980: 0x40182d  daddu       $v1, $v0, $zero
    ctx->pc = 0x121980u;
    SET_GPR_U64(ctx, 3, (uint64_t)GPR_U64(ctx, 2) + (uint64_t)GPR_U64(ctx, 0));
label_121984:
    // 0x121984: 0x8cc517b8  lw          $a1, 0x17B8($a2)
    ctx->pc = 0x121984u;
    SET_GPR_S32(ctx, 5, (int32_t)READ32(ADD32(GPR_U32(ctx, 6), 6072)));
label_121988:
    // 0x121988: 0x8c640128  lw          $a0, 0x128($v1)
    ctx->pc = 0x121988u;
    SET_GPR_S32(ctx, 4, (int32_t)READ32(ADD32(GPR_U32(ctx, 3), 296)));
label_12198c:
    // 0x12198c: 0x8c460004  lw          $a2, 0x4($v0)
    ctx->pc = 0x12198cu;
    SET_GPR_S32(ctx, 6, (int32_t)READ32(ADD32(GPR_U32(ctx, 2), 4)));
label_121990:
    // 0x121990: 0xdfbf0060  ld          $ra, 0x60($sp)
    ctx->pc = 0x121990u;
    SET_GPR_U64(ctx, 31, READ64(ADD32(GPR_U32(ctx, 29), 96)));
label_121994:
    // 0x121994: 0xdfb50050  ld          $s5, 0x50($sp)
    ctx->pc = 0x121994u;
    SET_GPR_U64(ctx, 21, READ64(ADD32(GPR_U32(ctx, 29), 80)));
label_121998:
    // 0x121998: 0xdfb40040  ld          $s4, 0x40($sp)
    ctx->pc = 0x121998u;
    SET_GPR_U64(ctx, 20, READ64(ADD32(GPR_U32(ctx, 29), 64)));
label_12199c:
    // 0x12199c: 0xdfb30030  ld          $s3, 0x30($sp)
    ctx->pc = 0x12199cu;
    SET_GPR_U64(ctx, 19, READ64(ADD32(GPR_U32(ctx, 29), 48)));
label_1219a0:
    // 0x1219a0: 0xdfb20020  ld          $s2, 0x20($sp)
    ctx->pc = 0x1219a0u;
    SET_GPR_U64(ctx, 18, READ64(ADD32(GPR_U32(ctx, 29), 32)));
label_1219a4:
    // 0x1219a4: 0xdfb10010  ld          $s1, 0x10($sp)
    ctx->pc = 0x1219a4u;
    SET_GPR_U64(ctx, 17, READ64(ADD32(GPR_U32(ctx, 29), 16)));
label_1219a8:
    // 0x1219a8: 0xdfb00000  ld          $s0, 0x0($sp)
    ctx->pc = 0x1219a8u;
    SET_GPR_U64(ctx, 16, READ64(ADD32(GPR_U32(ctx, 29), 0)));
label_1219ac:
    // 0x1219ac: 0x80489b2  j           func_1226C8
label_1219b0:
    if (ctx->pc == 0x1219B0u) {
        ctx->pc = 0x1219B0u;
            // 0x1219b0: 0x27bd0070  addiu       $sp, $sp, 0x70 (Delay Slot)
        SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 112));
        ctx->pc = 0x1219B4u;
