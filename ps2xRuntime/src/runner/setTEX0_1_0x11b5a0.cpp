...
void setTEX0_1_0x11b5a0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x11B634u;
    // 0x11b634: 0xdfbf0000  ld          $ra, 0x0($sp)
    ctx->pc = 0x11b634u;
    SET_GPR_U64(ctx, 31, READ64(ADD32(GPR_U32(ctx, 29), 0)));
    // 0x11b638: 0x3e00008  jr          $ra
    ctx->pc = 0x11B638u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x11B63Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x11B638u;
            // 0x11b63c: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
