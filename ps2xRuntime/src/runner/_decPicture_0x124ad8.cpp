...
void _decPicture_0x124ad8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    // 0x124aec: 0x8e2319ac
    ctx->pc = 0x124aecu;
    SET_GPR_U32(ctx, 3, READ32(ADD32(GPR_U32(ctx, 17), 6572)));
    // 0x124af0: 0x80902d
    ctx->pc = 0x124af0u;
    ...
    ctx->pc = 0x124AF8u;
    {
        const bool branch_taken_0x124af8 = (GPR_U32(ctx, 3) != GPR_U32(ctx, 2));
        ctx->pc = 0x124AFCu;
    ...
    ctx->pc = 0x124B08u;
    {
        const bool branch_taken_0x124b08 = (GPR_U32(ctx, 2) == GPR_U32(ctx, 0));
        ctx->pc = 0x124B0Cu;
        SET_GPR_U32(ctx, 3, READ32(ADD32(GPR_U32(ctx, 17), 6572)));
    ...
    ctx->pc = 0x124B18u;
    SET_GPR_S32(ctx, 4, ADD32(GPR_U32(ctx, 4), 20520));
    ctx->pc = 0x120018u;
    {
...
label_124b24:
    ...
    ctx->pc = 0x124B28u;
    {
        const bool branch_taken_0x124b28 = (GPR_U32(ctx, 3) == GPR_U32(ctx, 2));
        ctx->pc = 0x124B2Cu;
    ...
    ctx->pc = 0x124B30u;
    {
        const bool branch_taken_0x124b30 = (GPR_U32(ctx, 2) == GPR_U32(ctx, 0));
        ctx->pc = 0x124B34u;
    ...
    ctx->pc = 0x124B38u;
    {
        const bool branch_taken_0x124b38 = (GPR_U32(ctx, 3) == GPR_U32(ctx, 2));
        ctx->pc = 0x124B3Cu;
    ...
    ctx->pc = 0x124B40u;
    {
        const bool branch_taken_0x124b40 = (GPR_U32(ctx, 0) == GPR_U32(ctx, 0));
        ctx->pc = 0x124B44u;
        SET_GPR_U32(ctx, 4, ((uint32_t)23 << 16));
...
label_124b48:
    ...
    ctx->pc = 0x124B4Cu;
    {
        const bool branch_taken_0x124b4c = (GPR_U32(ctx, 3) != GPR_U32(ctx, 2));
        ctx->pc = 0x124B50u;
        SET_GPR_U32(ctx, 2, ((uint32_t)23 << 16));
    ...
    ctx->pc = 0x124B54u;
    {
        const bool branch_taken_0x124b54 = (GPR_U32(ctx, 0) == GPR_U32(ctx, 0));
        ctx->pc = 0x124B58u;
        SET_GPR_U32(ctx, 16, READ32(ADD32(GPR_U32(ctx, 2), 6724)));
...
label_124b5c:
    ...
    ctx->pc = 0x124B60u;
    {
        const bool branch_taken_0x124b60 = (GPR_U32(ctx, 0) == GPR_U32(ctx, 0));
        ctx->pc = 0x124B64u;
        SET_GPR_U32(ctx, 16, READ32(ADD32(GPR_U32(ctx, 2), 6728)));
...
label_124b68:
    ...
    ctx->pc = 0x124B6Cu;
    {
        const bool branch_taken_0x124b6c = (GPR_U32(ctx, 0) == GPR_U32(ctx, 0));
        ctx->pc = 0x124B70u;
        SET_GPR_U32(ctx, 16, READ32(ADD32(GPR_U32(ctx, 2), 6732)));
...
label_124b84:
    ...
    ctx->pc = 0x124B90u;
    {
        const bool branch_taken_0x124b90 = (GPR_U32(ctx, 3) == GPR_U32(ctx, 0));
        ctx->pc = 0x124B94u;
        SET_GPR_S32(ctx, 2, ADD32(GPR_U32(ctx, 0), 1));
