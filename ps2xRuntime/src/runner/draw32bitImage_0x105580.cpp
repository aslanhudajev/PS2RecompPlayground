...
label_1055e0:
    ...
    // 0x1055fc: 0x34c60006
    ctx->pc = 0x1055fcu;
    SET_GPR_U32(ctx, 6, OR32(GPR_U32(ctx, 6), 6));
    // 0x105600: 0x2405000e
    ctx->pc = 0x105600u;
    ...
    // 0x1056a8: 0x3c118000
    ctx->pc = 0x1056a8u;
    SET_GPR_U32(ctx, 17, ((uint32_t)32768 << 16));
    // 0x1056ac: 0x11883c
    ctx->pc = 0x1056acu;
    SET_GPR_U64(ctx, 17, GPR_U64(ctx, 17) << (32 + 0));
    // 0x1056b0: 0x36318001
    ctx->pc = 0x1056b0u;
    SET_GPR_U32(ctx, 17, OR32(GPR_U32(ctx, 17), 32769));
    // 0x1056b4: 0x3c124343
    ctx->pc = 0x1056b4u;
    SET_GPR_U32(ctx, 18, ((uint32_t)17219 << 16));
    // 0x1056b8: 0x36524343
    ctx->pc = 0x1056b8u;
    SET_GPR_U32(ctx, 18, OR32(GPR_U32(ctx, 18), 17219));
    // 0x1056bc: 0xff040030
    ctx->pc = 0x1056bcu;
