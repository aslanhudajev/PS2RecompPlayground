...
// Function: GetRotXYZ__FPiPiPi
// Address: 0x1c92f0 - 0x1c93e0
void GetRotXYZ__FPiPiPi_0x1c92f0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    PS2_INIT_LOG_ENTRY("GetRotXYZ__FPiPiPi");
    ...
    // 0x1c9344: 0xc07237c
    ctx->pc = 0x1C9344u;
    SET_GPR_U32(ctx, 31, 0x1C934Cu);
    ctx->pc = 0x1C9348u;
    { uint32_t bits = READ32(ADD32(GPR_U32(ctx, 29), 8)); float f; std::memcpy(&f, &bits, sizeof(f)); ctx->f[14] = f; }
    ctx->pc = 0x1C8DF0u;
    {
        const uint32_t __entryPc = ctx->pc;
        GetAngleXY__FfffPiPi_0x1c8df0(rdram, ctx, runtime);
        if (ctx->pc == __entryPc) { ctx->pc = 0x1C934Cu; }
        else if (ctx->pc != 0x1C934Cu) { ctx->pc = 0x1C934Cu; }
    }
    if (ctx->pc != 0x1C934Cu) { return; }
    ctx->pc = 0x1C934Cu;
    // 0x1c934c: 0x3c010026
    ctx->pc = 0x1c934cu;
    SET_GPR_U32(ctx, 1, ((uint32_t)38 << 16));
    ...
    ctx->pc = 0x1B03ECu;
    {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1C937Cu; }
        else if (ctx->pc != 0x1C937Cu) { ctx->pc = 0x1C937Cu; }
    }
    if (ctx->pc != 0x1C937Cu) { return; }
    ctx->pc = 0x1C937Cu;
    // 0x1c937c: 0x8e050000
    ctx->pc = 0x1c937cu;
    ...
    ctx->pc = 0x1B027Cu;
    {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1C9388u; }
        else if (ctx->pc != 0x1C9388u) { ctx->pc = 0x1C9388u; }
    }
    if (ctx->pc != 0x1C9388u) { return; }
    ctx->pc = 0x1C9388u;
    // 0x1c9388: 0x4bc6e1bc
    ctx->pc = 0x1c9388u;
    ...
    ctx->pc = 0x1A79A0u;
    {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x1C93A8u; }
        else if (ctx->pc != 0x1C93A8u) { ctx->pc = 0x1C93A8u; }
    }
    if (ctx->pc != 0x1C93A8u) { return; }
    ctx->pc = 0x1C93A8u;
    // 0x1c93a8: 0x21c3c
    ctx->pc = 0x1c93a8u;
