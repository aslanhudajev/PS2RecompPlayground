...
// Function: sub_001B0138
// Address: 0x1b0138 - 0x1b01bc
void sub_001B0138_0x1b0138(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    PS2_INIT_LOG_ENTRY("sub_001B0138");
    ...
    // 0x1b0144: 0xd88a0030
    ctx->pc = 0x1b0144u;
    ctx->vu0_vf[10] = _mm_castsi128_ps(READ128(ADD32(GPR_U32(ctx, 4), 48)));
label_1b0148:
    // 0x1b0148: 0x4be3e33c
    ctx->pc = 0x1b0148u;
