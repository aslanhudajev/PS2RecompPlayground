...
void drawSetDisplayBuffer_0x1089e8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    // 0x108a20: 0x34e70020
    ctx->pc = 0x108a20u;
    SET_GPR_U32(ctx, 7, OR32(GPR_U32(ctx, 7), 32));
    // 0x108a24: 0x35290070
    ctx->pc = 0x108a24u;
    SET_GPR_U32(ctx, 9, OR32(GPR_U32(ctx, 9), 112));
    // 0x108a28: 0x3c081200
    ctx->pc = 0x108a28u;
    ...
    // 0x108a34: 0x35080090
    ctx->pc = 0x108a34u;
    SET_GPR_U32(ctx, 8, OR32(GPR_U32(ctx, 8), 144));
    // 0x108a38: 0xdc820000
    ctx->pc = 0x108a38u;
    SET_GPR_U64(ctx, 2, READ64(ADD32(GPR_U32(ctx, 4), 0)));
    // 0x108a3c: 0x354a0080
    ctx->pc = 0x108a3cu;
    SET_GPR_U32(ctx, 10, OR32(GPR_U32(ctx, 10), 128));
    // 0x108a40: 0x3c051200
    ctx->pc = 0x108a40u;
    ...
    // 0x108a50: 0x34c600e0
    ctx->pc = 0x108a50u;
    SET_GPR_U32(ctx, 6, OR32(GPR_U32(ctx, 6), 224));
    // 0x108a54: 0xdfbf0000
    ctx->pc = 0x108a54u;
