...
// __unpack_f(src, dst): unpack IEEE 754 single into internal representation.
// dst[0] = type (0=nan, 1=snan, 2=zero, 3=normal, 4=inf)
// dst[1] = sign (0 or 1)
// dst[2] = exponent (for normal)
// dst[3] = mantissa (scaled for normal/denorm, raw for nan/inf)
// a0 = src (uint32*), a1 = dst (uint32*).
void ps2___unpack_f_0x2f96f8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
