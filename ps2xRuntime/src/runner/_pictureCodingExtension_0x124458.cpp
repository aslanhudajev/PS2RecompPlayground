...
void _pictureCodingExtension_0x124458(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    // 0x1244cc: 0x34c62010
    ctx->pc = 0x1244ccu;
    SET_GPR_U64(ctx, 6, GPR_U64(ctx, 6) | (uint64_t)8208);
    // 0x1244d0: 0x3c05fffc
    ctx->pc = 0x1244d0u;
    SET_GPR_S32(ctx, 5, ((uint32_t)65532 << 16));
    // 0x1244d4: 0x8cc30000
    ctx->pc = 0x1244d4u;
...
label_124508:
    ...
    // 0x124550: 0x3c03ffbf
    ctx->pc = 0x124550u;
    SET_GPR_S32(ctx, 3, ((uint32_t)65471 << 16));
    // 0x124554: 0x3463ffff
    ctx->pc = 0x124554u;
    ...
    // 0x124588: 0x3c03ffdf
    ctx->pc = 0x124588u;
    SET_GPR_S32(ctx, 3, ((uint32_t)65503 << 16));
    // 0x12458c: 0x3463ffff
    ctx->pc = 0x12458cu;
    SET_GPR_U64(ctx, 3, GPR_U64(ctx, 3) | (uint64_t)65535);
    // 0x124590: 0x22540
    ...
    // 0x1245bc: 0x3c03ffef
    ctx->pc = 0x1245bcu;
    SET_GPR_S32(ctx, 3, ((uint32_t)65519 << 16));
    // 0x1245c0: 0x3463ffff
    ctx->pc = 0x1245c0u;
    SET_GPR_U64(ctx, 3, GPR_U64(ctx, 3) | (uint64_t)65535);
    // 0x1245c4: 0x22500
