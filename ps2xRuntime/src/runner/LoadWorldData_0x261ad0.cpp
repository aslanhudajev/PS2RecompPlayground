...
void LoadWorldData_0x261ad0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    // 0x261b38: 0x2761818  mult $v1, $s3, $s6 (R5900: also writes LO to rd=$v1)
    ctx->pc = 0x261b38u;
    { int64_t result = (int64_t)GPR_S32(ctx, 19) * (int64_t)GPR_S32(ctx, 22); ctx->lo = (uint32_t)result; ctx->hi = (uint32_t)(result >> 32); SET_GPR_S32(ctx, 3, (int32_t)(uint32_t)result); }
    // 0x261b3c: 0x0
    ctx->pc = 0x261b3cu;
    // NOP
label_261b40:
...
label_261bb8:
    ...
    // 0x261c94: 0x72761800  madd $v1, $s3, $s6 (R5900: also writes LO to rd=$v1)
    ctx->pc = 0x261c94u;
    { int64_t acc = ((int64_t)ctx->hi << 32) | ctx->lo; int64_t prod = (int64_t)GPR_S32(ctx, 19) * (int64_t)GPR_S32(ctx, 22); int64_t result = acc + prod; ctx->lo = (uint32_t)result; ctx->hi = (uint32_t)(result >> 32); SET_GPR_S32(ctx, 3, (int32_t)(uint32_t)result); }
    // 0x261c98: 0x8c620000
    ctx->pc = 0x261c98u;
...
label_261cac:
    ...
    // 0x261cc0: 0x72761000  madd $v0, $s3, $s6 (R5900: also writes LO to rd=$v0)
    ctx->pc = 0x261cc0u;
    { int64_t acc = ((int64_t)ctx->hi << 32) | ctx->lo; int64_t prod = (int64_t)GPR_S32(ctx, 19) * (int64_t)GPR_S32(ctx, 22); int64_t result = acc + prod; ctx->lo = (uint32_t)result; ctx->hi = (uint32_t)(result >> 32); SET_GPR_S32(ctx, 2, (int32_t)(uint32_t)result); }
    // 0x261cc4: 0x3c040034
    ctx->pc = 0x261cc4u;
    SET_GPR_U32(ctx, 4, ((uint32_t)52 << 16));
    // 0x261cc8: 0x1000000c
    ...
    ctx->pc = 0x261CD0u;
label_261cd0:
    // 0x261cd0: 0x2761018  mult $v0, $s3, $s6 (R5900: also writes LO to rd=$v0)
    ctx->pc = 0x261cd0u;
    { int64_t result = (int64_t)GPR_S32(ctx, 19) * (int64_t)GPR_S32(ctx, 22); ctx->lo = (uint32_t)result; ctx->hi = (uint32_t)(result >> 32); SET_GPR_S32(ctx, 2, (int32_t)(uint32_t)result); }
    // 0x261cd4: 0x3c050034
    ctx->pc = 0x261cd4u;
...
label_261d38:
    ...
    // 0x261d4c: 0x2272018  mult $a0, $s1, $a3 (R5900: also writes LO to rd=$a0)
    ctx->pc = 0x261d4cu;
    { int64_t result = (int64_t)GPR_S32(ctx, 17) * (int64_t)GPR_S32(ctx, 7); ctx->lo = (uint32_t)result; ctx->hi = (uint32_t)(result >> 32); SET_GPR_S32(ctx, 4, (int32_t)(uint32_t)result); }
    // 0x261d50: 0x8ca6001c
    ctx->pc = 0x261d50u;
    ...
    ctx->pc = 0x261D9Cu;
    {
        ...
        ctx->pc = 0x261DA0u;
        { int64_t result = (int64_t)GPR_S32(ctx, 17) * (int64_t)GPR_S32(ctx, 7); ctx->lo = (uint32_t)result; ctx->hi = (uint32_t)(result >> 32); SET_GPR_S32(ctx, 3, (int32_t)(uint32_t)result); }
...
label_261dc8:
    ...
    ctx->pc = 0x261DCCu;
    {
        ...
        ctx->pc = 0x261DD0u;
        { int64_t result = (int64_t)GPR_S32(ctx, 17) * (int64_t)GPR_S32(ctx, 6); ctx->lo = (uint32_t)result; ctx->hi = (uint32_t)(result >> 32); SET_GPR_S32(ctx, 3, (int32_t)(uint32_t)result); }
...
label_261df0:
    ...
    // 0x261e08: 0x2221018  mult $v0, $s1, $v0 (R5900: also writes LO to rd=$v0)
    ctx->pc = 0x261e08u;
