...
label_103738:
    ...
    // 0x10374c: 0x34a50005
    ctx->pc = 0x10374cu;
    SET_GPR_U64(ctx, 5, GPR_U64(ctx, 5) | (uint64_t)5);
    // 0x103750: 0x7c430010
    ctx->pc = 0x103750u;
    ...
    // 0x1037cc: 0x34048000
    ctx->pc = 0x1037ccu;
    SET_GPR_U64(ctx, 4, GPR_U64(ctx, 0) | (uint64_t)32768);
    // 0x1037d0: 0x423bc
    ctx->pc = 0x1037d0u;
    ...
    *(uint32_t*)&ctx->f[22] = GPR_U32(ctx, 2);
    ...
    // 0x103824: 0x3c098000
    ctx->pc = 0x103824u;
    SET_GPR_S32(ctx, 9, ((uint32_t)32768 << 16));
    // 0x103828: 0x9483c
    ctx->pc = 0x103828u;
    ...
    // 0x103834: 0x3c0a4343
    ctx->pc = 0x103834u;
    SET_GPR_S32(ctx, 10, ((uint32_t)17219 << 16));
    // 0x103838: 0x354a4343
    ctx->pc = 0x103838u;
    SET_GPR_U64(ctx, 10, GPR_U64(ctx, 10) | (uint64_t)17219);
    // 0x10383c: 0xfe200058
    ctx->pc = 0x10383cu;
    ...
    *(uint32_t*)&ctx->f[23] = GPR_U32(ctx, 19);
    ...
    // 0x1038e4: 0x3c050010
    ctx->pc = 0x1038e4u;
    SET_GPR_S32(ctx, 5, ((uint32_t)16 << 16));
    // 0x1038e8: 0x4600ab06
    ctx->pc = 0x1038e8u;
    ctx->f[12] = FPU_MOV_S(ctx->f[21]);
    // 0x1038ec: 0x260300a0
