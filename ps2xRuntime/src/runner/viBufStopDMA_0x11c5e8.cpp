...
void viBufStopDMA_0x11c5e8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    // 0x11c618: 0x34c6b430
    ctx->pc = 0x11c618u;
    SET_GPR_U64(ctx, 6, GPR_U64(ctx, 6) | (uint64_t)46128);
    // 0x11c61c: 0x8c430000
    ctx->pc = 0x11c61cu;
    ...
    // 0x11c630: 0x34a5b400
    ctx->pc = 0x11c630u;
    SET_GPR_U64(ctx, 5, GPR_U64(ctx, 5) | (uint64_t)46080);
    // 0x11c634: 0x3c071000
    ctx->pc = 0x11c634u;
    ...
    // 0x11c63c: 0x34e72010
    ctx->pc = 0x11c63cu;
    SET_GPR_U64(ctx, 7, GPR_U64(ctx, 7) | (uint64_t)8208);
    // 0x11c640: 0xae030020
    ctx->pc = 0x11c640u;
...
label_11c658:
    ...
    // 0x11c688: 0x3508b020
    ctx->pc = 0x11c688u;
    SET_GPR_U64(ctx, 8, GPR_U64(ctx, 8) | (uint64_t)45088);
    // 0x11c68c: 0x8c430000
    ctx->pc = 0x11c68cu;
    SET_GPR_U32(ctx, 3, runtime->Load32(rdram, ctx, ADD32(GPR_U32(ctx, 2), 0))); // MMIO: 0x10000000
    // 0x11c690: 0x3c061000
    ...
    // 0x11c694: 0x34c6b000
    ctx->pc = 0x11c694u;
    SET_GPR_U64(ctx, 6, GPR_U64(ctx, 6) | (uint64_t)45056);
    // 0x11c698: 0x3c071000
    ctx->pc = 0x11c698u;
    SET_GPR_S32(ctx, 7, ((uint32_t)4096 << 16));
    // 0x11c69c: 0xae03002c
    ...
    // 0x11c6a0: 0x34e72020
    ctx->pc = 0x11c6a0u;
    SET_GPR_U64(ctx, 7, GPR_U64(ctx, 7) | (uint64_t)8224);
    // 0x11c6a4: 0x3c051000
    ctx->pc = 0x11c6a4u;
    SET_GPR_S32(ctx, 5, ((uint32_t)4096 << 16));
    // 0x11c6a8: 0x8e040040
