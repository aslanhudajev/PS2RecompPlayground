...
// Function: UnInitEn7_01_Hontai
// Address: 0x1af380 - 0x1af3ac
void UnInitEn7_01_Hontai_0x1af380(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
#ifdef _DEBUG
    PS_LOG_ENTRY("UnInitEn7_01_Hontai_0x1af380");
#endif

    ctx->pc = 0x1af380u;

    // 0x1af380: 0x27bdfff0  addiu       $sp, $sp, -0x10
    ctx->pc = 0x1af380u;
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 4294967280));
    // 0x1af384: 0xffbf0000  sd          $ra, 0x0($sp)
    ctx->pc = 0x1af384u;
    WRITE64(ADD32(GPR_U32(ctx, 29), 0), GPR_U64(ctx, 31));
    // 0x1af388: 0xc05c1d0  jal         func_170740
    ctx->pc = 0x1AF388u;
    SET_GPR_U32(ctx, 31, 0x1AF390u);
    ctx->pc = 0x1AF38Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1AF388u;
            // 0x1af38c: 0x24040016  addiu       $a0, $zero, 0x16 (Delay Slot)
    ...
    ctx->pc = 0x1AF390u;
    // 0x1af390: 0xc05c1c0  jal         func_170700
    ctx->pc = 0x1AF390u;
    SET_GPR_U32(ctx, 31, 0x1AF398u);
    ctx->pc = 0x1AF394u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1AF390u;
            // 0x1af394: 0x40202d  daddu       $a0, $v0, $zero (Delay Slot)
    ...
    ctx->pc = 0x1AF398u;
    // 0x1af398: 0xc060680  jal         func_181A00
    ctx->pc = 0x1AF398u;
    SET_GPR_U32(ctx, 31, 0x1AF3A0u);
    ctx->pc = 0x1AF39Cu;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1AF398u;
            // 0x1af39c: 0x24040029  addiu       $a0, $zero, 0x29 (Delay Slot)
    ...
    ctx->pc = 0x1AF3A0u;
    // 0x1af3a0: 0xdfbf0000  ld          $ra, 0x0($sp)
    ctx->pc = 0x1af3a0u;
    SET_GPR_U64(ctx, 31, READ64(ADD32(GPR_U32(ctx, 29), 0)));
    // 0x1af3a4: 0x3e00008  jr          $ra
    ctx->pc = 0x1AF3A4u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x1AF3A8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1AF3A4u;
            // 0x1af3a8: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
