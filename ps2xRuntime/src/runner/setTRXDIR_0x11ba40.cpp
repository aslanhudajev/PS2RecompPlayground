...
void setTRXDIR_0x11ba40(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
#ifdef _DEBUG
    PS_LOG_ENTRY("setTRXDIR_0x11ba40");
#endif

    ctx->pc = 0x11ba40u;

    // 0x11ba40: 0x5283c  dsll32      $a1, $a1, 0
    ctx->pc = 0x11ba40u;
    SET_GPR_U64(ctx, 5, GPR_U64(ctx, 5) << (32 + 0));
    // 0x11ba44: 0x27bdfff0  addiu       $sp, $sp, -0x10
    ctx->pc = 0x11ba44u;
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 4294967280));
    // 0x11ba48: 0x5303e  dsrl32      $a2, $a1, 0
    ctx->pc = 0x11ba48u;
    SET_GPR_U64(ctx, 6, GPR_U64(ctx, 5) >> (32 + 0));
    // 0x11ba4c: 0xffbf0000  sd          $ra, 0x0($sp)
    ctx->pc = 0x11ba4cu;
    WRITE64(ADD32(GPR_U32(ctx, 29), 0), GPR_U64(ctx, 31));
    // 0x11ba50: 0xc046d3a  jal         func_11B4E8
    ctx->pc = 0x11BA50u;
    SET_GPR_U32(ctx, 31, 0x11BA58u);
    ctx->pc = 0x11BA54u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x11BA50u;
            // 0x11ba54: 0x24050053  addiu       $a1, $zero, 0x53 (Delay Slot)
    ...
    ctx->pc = 0x11BA58u;
    // 0x11ba58: 0xdfbf0000  ld          $ra, 0x0($sp)
    ctx->pc = 0x11ba58u;
    SET_GPR_U64(ctx, 31, READ64(ADD32(GPR_U32(ctx, 29), 0)));
    // 0x11ba5c: 0x3e00008  jr          $ra
    ctx->pc = 0x11BA5Cu;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x11BA60u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x11BA5Cu;
            // 0x11ba60: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
