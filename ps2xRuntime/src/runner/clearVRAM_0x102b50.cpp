...
void clearVRAM_0x102b50(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    // 0x102b60: 0x3c121000
    ctx->pc = 0x102b60u;
    SET_GPR_S32(ctx, 18, ((uint32_t)4096 << 16));
    // 0x102b64: 0xffb00000
    ctx->pc = 0x102b64u;
    WRITE64(ADD32(GPR_U32(ctx, 29), 0), GPR_U64(ctx, 16));
    // 0x102b68: 0x36524006
    ctx->pc = 0x102b68u;
    SET_GPR_U64(ctx, 18, GPR_U64(ctx, 18) | (uint64_t)16390);
    // 0x102b6c: 0xffbf0040
    ctx->pc = 0x102b6cu;
    ...
    // 0x102b78: 0x3c130800
    ctx->pc = 0x102b78u;
    SET_GPR_S32(ctx, 19, ((uint32_t)2048 << 16));
    // 0x102b7c: 0x13983c
    ctx->pc = 0x102b7cu;
    SET_GPR_U64(ctx, 19, GPR_U64(ctx, 19) << (32 + 0));
    // 0x102b80: 0x3673c000
    ctx->pc = 0x102b80u;
    SET_GPR_U64(ctx, 19, GPR_U64(ctx, 19) | (uint64_t)49152);
    // 0x102b84: 0x10203c
    ctx->pc = 0x102b84u;
...
label_102b88:
    ...
    // 0x102ba4: 0x34a50004
    ctx->pc = 0x102ba4u;
    SET_GPR_U64(ctx, 5, GPR_U64(ctx, 5) | (uint64_t)4);
    // 0x102ba8: 0x7c430000
    ctx->pc = 0x102ba8u;
    ...
    // 0x102bc0: 0x35080100
    ctx->pc = 0x102bc0u;
    SET_GPR_U64(ctx, 8, GPR_U64(ctx, 8) | (uint64_t)256);
    // 0x102bc4: 0x24090052
    ctx->pc = 0x102bc4u;
...
label_102c10:
    ...
    // 0x102c50: 0x3463a000
    ctx->pc = 0x102c50u;
    SET_GPR_U64(ctx, 3, GPR_U64(ctx, 3) | (uint64_t)40960);
    // 0x102c54: 0x0
    ctx->pc = 0x102c54u;
    // NOP
label_102c58:
