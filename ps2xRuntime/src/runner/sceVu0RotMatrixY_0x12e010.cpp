...
// Ghidra decomp: angle from $f12, build Ry matrix
void sceVu0RotMatrixY_0x12e010(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
#ifdef _DEBUG
    PS_LOG_ENTRY("sceVu0RotMatrixY_0x12e010");
#endif
    (void)runtime;
