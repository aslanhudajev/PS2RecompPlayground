...
void _sendDataToIPU_0x120070(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    // 0x120070: 0x3c0f0075
    ctx->pc = 0x120070u;
    SET_GPR_S32(ctx, 15, ((uint32_t)117 << 16));
    // 0x120074: 0x3c020fff
    ctx->pc = 0x120074u;
    ...
    // 0x120084: 0x3c062000
    ctx->pc = 0x120084u;
    SET_GPR_S32(ctx, 6, ((uint32_t)8192 << 16));
    // 0x120088: 0x665825
    ctx->pc = 0x120088u;
    ...
    // 0x120098: 0x3c09000f
    ctx->pc = 0x120098u;
    SET_GPR_S32(ctx, 9, ((uint32_t)15 << 16));
    // 0x12009c: 0x3c0c0fff
    ctx->pc = 0x12009cu;
    SET_GPR_S32(ctx, 12, ((uint32_t)4095 << 16));
    // 0x1200a0: 0x3529ff40
    ctx->pc = 0x1200a0u;
    SET_GPR_U64(ctx, 9, GPR_U64(ctx, 9) | (uint64_t)65344);
    // 0x1200a4: 0x358cffff
    ctx->pc = 0x1200a4u;
    SET_GPR_U64(ctx, 12, GPR_U64(ctx, 12) | (uint64_t)65535);
    // 0x1200a8: 0x240e0003
    ctx->pc = 0x1200a8u;
...
label_120108:
    ...
    // 0x12011c: 0x3463b430
    ctx->pc = 0x12011cu;
    SET_GPR_U64(ctx, 3, GPR_U64(ctx, 3) | (uint64_t)46128);
    // 0x120120: 0x3c021000
    ctx->pc = 0x120120u;
