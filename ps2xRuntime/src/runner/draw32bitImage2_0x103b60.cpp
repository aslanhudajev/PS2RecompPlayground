...
label_103bc0:
    ...
    // 0x103c6c: 0x34a52b00
    ctx->pc = 0x103c6cu;
    SET_GPR_U64(ctx, 5, GPR_U64(ctx, 5) | (uint64_t)11008);
    // 0x103c70: 0x8f9582b8
    ctx->pc = 0x103c70u;
    ...
    // 0x103c94: 0x356b0029
    ctx->pc = 0x103c94u;
    SET_GPR_U64(ctx, 11, GPR_U64(ctx, 11) | (uint64_t)41);
    // 0x103c98: 0x240c0042
    ctx->pc = 0x103c98u;
    ...
    // 0x103ca0: 0x3c0e8000
    ctx->pc = 0x103ca0u;
    SET_GPR_S32(ctx, 14, ((uint32_t)32768 << 16));
    // 0x103ca4: 0xe703c
    ctx->pc = 0x103ca4u;
    ...
    // 0x103cac: 0x3c0f4343
    ctx->pc = 0x103cacu;
    SET_GPR_S32(ctx, 15, ((uint32_t)17219 << 16));
    // 0x103cb0: 0x35ef4343
    ctx->pc = 0x103cb0u;
    SET_GPR_U64(ctx, 15, GPR_U64(ctx, 15) | (uint64_t)17219);
    // 0x103cb4: 0xfea40030
    ctx->pc = 0x103cb4u;
