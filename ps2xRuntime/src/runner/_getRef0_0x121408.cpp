...
void _getRef0_0x121408(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    // 0x121414: 0x25831df8
    ctx->pc = 0x121414u;
    SET_GPR_S32(ctx, 3, ADD32(GPR_U32(ctx, 12), 7672));
    // 0x121418: 0xffb50070
    ctx->pc = 0x121418u;
    ...
    // 0x12147c: 0x8c4217b8
    ctx->pc = 0x12147cu;
    SET_GPR_U32(ctx, 2, READ32(ADD32(GPR_U32(ctx, 2), 6072)));
    // 0x121480: 0x8fb500b0
    ctx->pc = 0x121480u;
    ...
    ctx->pc = 0x1214A8u;
    {
        const bool branch_taken_0x1214a8 = (GPR_U32(ctx, 15) == GPR_U32(ctx, 0));
        ctx->pc = 0x1214ACu;
    ...
    ctx->pc = 0x1214B8u;
    {
        const bool branch_taken_0x1214b8 = (GPR_U32(ctx, 0) == GPR_U32(ctx, 0));
        ctx->pc = 0x1214BCu;
...
label_1214c8:
    ...
    ctx->pc = 0x121518u;
    {
        const bool branch_taken_0x121518 = (GPR_U32(ctx, 25) == GPR_U32(ctx, 0));
        ctx->pc = 0x12151Cu;
    ...
    ctx->pc = 0x12152Cu;
    {
        const bool branch_taken_0x12152c = (GPR_U32(ctx, 2) != GPR_U32(ctx, 0));
    ...
    ctx->pc = 0x121550u;
    {
        const bool branch_taken_0x121550 = (GPR_U32(ctx, 0) == GPR_U32(ctx, 0));
        ctx->pc = 0x121554u;
...
label_121558:
    ...
    ctx->pc = 0x121584u;
    {
        const bool branch_taken_0x121584 = (GPR_U32(ctx, 0) == GPR_U32(ctx, 0));
        ctx->pc = 0x121588u;
...
label_121590:
    ...
    // 0x121598: 0x24621df8
    ctx->pc = 0x121598u;
    SET_GPR_S32(ctx, 2, ADD32(GPR_U32(ctx, 3), 7672));
    // 0x12159c: 0x2e73818
    ctx->pc = 0x12159cu;
    ...
    ctx->pc = 0x121620u;
    {
        const bool branch_taken_0x121620 = (GPR_U32(ctx, 15) == GPR_U32(ctx, 0));
        ctx->pc = 0x121624u;
    ...
    ctx->pc = 0x12163Cu;
    {
        const bool branch_taken_0x12163c = (GPR_U32(ctx, 0) == GPR_U32(ctx, 0));
        ctx->pc = 0x121640u;
        SET_GPR_U32(ctx, 6, ADD32(GPR_U32(ctx, 2), GPR_U32(ctx, 3)));
...
label_121658:
    ...
    ctx->pc = 0x121694u;
    {
        const bool branch_taken_0x121694 = (GPR_U32(ctx, 25) == GPR_U32(ctx, 0));
        ctx->pc = 0x121698u;
    ...
    ctx->pc = 0x1216A8u;
    {
        const bool branch_taken_0x1216a8 = (GPR_U32(ctx, 2) != GPR_U32(ctx, 0));
    ...
    ctx->pc = 0x1216CCu;
    {
        const bool branch_taken_0x1216cc = (GPR_U32(ctx, 0) == GPR_U32(ctx, 0));
        ctx->pc = 0x1216D0u;
...
label_1216d4:
    ...
    ctx->pc = 0x1216E0u;
    {
        const bool branch_taken_0x1216e0 = (GPR_U32(ctx, 2) != GPR_U32(ctx, 0));
...
label_12170c:
    ...
    // 0x121718: 0x26271df8
    ctx->pc = 0x121718u;
    SET_GPR_S32(ctx, 7, ADD32(GPR_U32(ctx, 17), 7672));
    // 0x12171c: 0xae020010
    ctx->pc = 0x12171cu;
    ...
    // 0x12175c: 0x246320c8
    ctx->pc = 0x12175cu;
    SET_GPR_S32(ctx, 3, ADD32(GPR_U32(ctx, 3), 8392));
    // 0x121760: 0x8ecd0000
    ctx->pc = 0x121760u;
    ...
    // 0x1217a0: 0x24a520e8
    ctx->pc = 0x1217a0u;
    SET_GPR_S32(ctx, 5, ADD32(GPR_U32(ctx, 5), 8424));
    // 0x1217a4: 0x21080
    ctx->pc = 0x1217a4u;
