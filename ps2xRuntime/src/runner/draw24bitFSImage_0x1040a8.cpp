...
void draw24bitFSImage_0x1040a8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    // 0x1040f0: 0x34c60007
    ctx->pc = 0x1040f0u;
    SET_GPR_U32(ctx, 6, OR32(GPR_U32(ctx, 6), 7));
    // 0x1040f4: 0x7d020000
    ctx->pc = 0x1040f4u;
    ...
    // 0x104188: 0x3c0a7f7f
    ctx->pc = 0x104188u;
    SET_GPR_U32(ctx, 10, ((uint32_t)32639 << 16));
    // 0x10418c: 0x354a7f7f
    ctx->pc = 0x10418cu;
    SET_GPR_U32(ctx, 10, OR32(GPR_U32(ctx, 10), 32639));
    // 0x104190: 0x240b0001
    ctx->pc = 0x104190u;
    SET_GPR_S32(ctx, 11, ADD32(GPR_U32(ctx, 0), 1));
    // 0x104194: 0x3c0c0002
    ctx->pc = 0x104194u;
    SET_GPR_U32(ctx, 12, ((uint32_t)2 << 16));
    // 0x104198: 0x240e0047
    ctx->pc = 0x104198u;
    ...
    // 0x1041a4: 0x3631807f
    ctx->pc = 0x1041a4u;
    SET_GPR_U32(ctx, 17, OR32(GPR_U32(ctx, 17), 32895));
    // 0x1041a8: 0x2412003b
    ctx->pc = 0x1041a8u;
    ...
    // 0x1041b4: 0x36738001
    ctx->pc = 0x1041b4u;
    SET_GPR_U32(ctx, 19, OR32(GPR_U32(ctx, 19), 32769));
    // 0x1041b8: 0x3c154343
    ctx->pc = 0x1041b8u;
    SET_GPR_U32(ctx, 21, ((uint32_t)17219 << 16));
    // 0x1041bc: 0x36b54343
    ctx->pc = 0x1041bcu;
    SET_GPR_U32(ctx, 21, OR32(GPR_U32(ctx, 21), 17219));
    // 0x1041c0: 0xff100030
    ctx->pc = 0x1041c0u;
    ...
    // 0x1041e4: 0x34149408
    ctx->pc = 0x1041e4u;
    SET_GPR_U32(ctx, 20, OR32(GPR_U32(ctx, 0), 37896));
    // 0x1041e8: 0xff0a0060
    ctx->pc = 0x1041e8u;
    ...
    // 0x104204: 0x340a9008
    ctx->pc = 0x104204u;
    SET_GPR_U32(ctx, 10, OR32(GPR_U32(ctx, 0), 36872));
    // 0x104208: 0xff130090
    ctx->pc = 0x104208u;
    ...
    // 0x104214: 0x3c0b7000
    ctx->pc = 0x104214u;
    SET_GPR_U32(ctx, 11, ((uint32_t)28672 << 16));
    // 0x104218: 0xaf1600b0
    ctx->pc = 0x104218u;
