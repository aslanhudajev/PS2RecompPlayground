...
label_118c6c:
    ...
    ctx->pc = 0x118C68u;
    {
        const bool branch_taken_0x118c68 = (GPR_U32(ctx, 0) == GPR_U32(ctx, 0));
        ctx->pc = 0x118C6Cu;
        SET_GPR_U64(ctx, 19, (uint64_t)GPR_U64(ctx, 18) + (uint64_t)GPR_U64(ctx, 0));
...
label_118c78:
    ...
    ctx->pc = 0x118C74u;
    {
        const bool branch_taken_0x118c74 = (GPR_U32(ctx, 2) != GPR_U32(ctx, 0));
        ctx->pc = 0x118C78u;
        SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 16) + (uint64_t)GPR_U64(ctx, 0));
...
label_118c90:
    if (ctx->pc == 0x118C90u) {
        ctx->pc = 0x118C90u;
        SET_GPR_S32(ctx, 4, ADD32(GPR_U32(ctx, 2), 4294960584));
        ctx->pc = 0x118C94u;
        goto label_118c94;
    }
    ctx->pc = 0x118C8Cu;
...
label_118cb4:
    ...
    ctx->pc = 0x118CB0u;
    {
        const bool branch_taken_0x118cb0 = (GPR_U32(ctx, 2) == GPR_U32(ctx, 0));
        ctx->pc = 0x118CB4u;
        SET_GPR_U32(ctx, 5, READ32(ADD32(GPR_U32(ctx, 29), 0)));
...
label_118cf4:
    // 0x118cf4: 0x8ee80008
    ctx->pc = 0x118cf4u;
    SET_GPR_U32(ctx, 8, READ32(ADD32(GPR_U32(ctx, 23), 8)));
label_118cf8:
    // 0x118cf8: 0x220202d
    ctx->pc = 0x118cf8u;
...
label_118d20:
    ...
    ctx->pc = 0x118D1Cu;
    {
        const bool branch_taken_0x118d1c = (GPR_U32(ctx, 21) != GPR_U32(ctx, 0));
        ctx->pc = 0x118D20u;
        SET_GPR_U32(ctx, 2, SLT32(GPR_S32(ctx, 18), 5));
...
label_118d34:
    ...
    ctx->pc = 0x118D30u;
    {
        const bool branch_taken_0x118d30 = (GPR_U32(ctx, 2) == GPR_U32(ctx, 0));
        ctx->pc = 0x118D34u;
        SET_GPR_U32(ctx, 2, SLT32(GPR_S32(ctx, 18), 5));
...
label_118d44:
    ...
    ctx->pc = 0x118D40u;
    {
        const bool branch_taken_0x118d40 = (GPR_U32(ctx, 2) == GPR_U32(ctx, 0));
        ctx->pc = 0x118D44u;
        SET_GPR_U32(ctx, 2, SLT32(GPR_S32(ctx, 18), 5));
...
label_118d58:
    ...
    ctx->pc = 0x118D54u;
    {
        const bool branch_taken_0x118d54 = (GPR_U32(ctx, 2) == GPR_U32(ctx, 0));
        ctx->pc = 0x118D58u;
        SET_GPR_S32(ctx, 21, ADD32(GPR_U32(ctx, 0), 1));
...
label_118d60:
    if (ctx->pc == 0x118D60u) {
        ctx->pc = 0x118D60u;
        SET_GPR_S32(ctx, 4, ADD32(GPR_U32(ctx, 30), 4294960488));
        ctx->pc = 0x118D64u;
        goto label_118d64;
    }
    ctx->pc = 0x118D5Cu;
...
label_118d70:
    ...
    ctx->pc = 0x118D6Cu;
    {
        const bool branch_taken_0x118d6c = (GPR_U32(ctx, 2) != GPR_U32(ctx, 0));
...
label_118d84:
    ...
    ctx->pc = 0x118D80u;
    {
        const bool branch_taken_0x118d80 = (GPR_U32(ctx, 2) != GPR_U32(ctx, 3));
...
label_118d8c:
    ...
    ctx->pc = 0x118D88u;
    {
        const bool branch_taken_0x118d88 = (GPR_U32(ctx, 0) == GPR_U32(ctx, 0));
...
label_118da4:
    ...
    ctx->pc = 0x118DA0u;
    {
        const bool branch_taken_0x118da0 = (GPR_U32(ctx, 2) == GPR_U32(ctx, 0));
        ctx->pc = 0x118DA4u;
        SET_GPR_S32(ctx, 16, ADD32(GPR_U32(ctx, 0), 3));
...
label_118dac:
    ...
    ctx->pc = 0x118DA8u;
    {
        const bool branch_taken_0x118da8 = (GPR_U32(ctx, 0) == GPR_U32(ctx, 0));
...
label_118dc4:
    ...
    ctx->pc = 0x118DC0u;
    {
        const bool branch_taken_0x118dc0 = (GPR_U32(ctx, 2) != GPR_U32(ctx, 0));
...
label_118dd4:
    ...
    ctx->pc = 0x118DD0u;
    {
        const bool branch_taken_0x118dd0 = (GPR_U32(ctx, 2) != GPR_U32(ctx, 16));
...
label_118de8:
    ...
    ctx->pc = 0x118DE4u;
    {
        const bool branch_taken_0x118de4 = (GPR_U32(ctx, 2) == GPR_U32(ctx, 0));
        ctx->pc = 0x118DE8u;
        SET_GPR_U64(ctx, 31, READ64(ADD32(GPR_U32(ctx, 29), 160)));
