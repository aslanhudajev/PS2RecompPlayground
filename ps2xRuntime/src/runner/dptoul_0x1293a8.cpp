...
void dptoul_0x1293a8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1293C8u;
    {
        const bool branch_taken_0x1293c8 = (GPR_U32(ctx, 2) == GPR_U32(ctx, 0));
        ctx->pc = 0x1293CCu;
    ...
    ctx->pc = 0x1293D0u;
    {
        const bool branch_taken_0x1293d0 = (GPR_U32(ctx, 2) == GPR_U32(ctx, 0));
        ctx->pc = 0x1293D4u;
...
label_1293d8:
    ...
    ctx->pc = 0x1293D8u;
    {
        const bool branch_taken_0x1293d8 = (GPR_U32(ctx, 0) == GPR_U32(ctx, 0));
        ctx->pc = 0x1293DCu;
...
label_1293e0:
    ...
    ctx->pc = 0x1293E0u;
    {
        const bool branch_taken_0x1293e0 = (GPR_U32(ctx, 2) != GPR_U32(ctx, 0));
        ctx->pc = 0x1293E4u;
        SET_GPR_U64(ctx, 2, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
    ...
    ctx->pc = 0x1293ECu;
    {
        const bool branch_taken_0x1293ec = (GPR_U32(ctx, 2) == GPR_U32(ctx, 0));
        ctx->pc = 0x1293F0u;
    ...
    ctx->pc = 0x1293FCu;
    {
        const bool branch_taken_0x1293fc = (GPR_U32(ctx, 2) != GPR_U32(ctx, 0));
...
label_129410:
    ...
    ctx->pc = 0x129410u;
    {
        const bool branch_taken_0x129410 = (GPR_U32(ctx, 2) != GPR_U32(ctx, 0));
        ctx->pc = 0x129414u;
    ...
    ctx->pc = 0x129420u;
    {
        const bool branch_taken_0x129420 = (GPR_U32(ctx, 0) == GPR_U32(ctx, 0));
        ctx->pc = 0x129424u;
