...
// Address: 0x2de1b8 - 0x2de1ec
void videoDecInputSpaceCount_0x2de1b8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x2DE0E0u;
    {
        ...
        if (ctx->pc == __entryPc) { ctx->pc = 0x2DE1D4u; }
    }
    if (ctx->pc != 0x2DE1D4u) { return; }
    ctx->pc = 0x2DE1D4u;
    // 0x2de1d4: 0x8fa30004
    ctx->pc = 0x2de1d4u;
