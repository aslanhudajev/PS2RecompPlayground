...
#ifdef _DEBUG
    PS_LOG_ENTRY("VSync_0x10e720");
#endif

    ctx->pc = 0x10e720u;

    // 0x10e720: 0x3c021000  lui         $v0, 0x1000
    ctx->pc = 0x10e720u;
    SET_GPR_S32(ctx, 2, (int32_t)((uint32_t)4096 << 16));
    // 0x10e724: 0x24030004  addiu       $v1, $zero, 0x4
    ctx->pc = 0x10e724u;
    SET_GPR_S32(ctx, 3, (int32_t)ADD32(GPR_U32(ctx, 0), 4));
    // 0x10e728: 0x3442f000  ori         $v0, $v0, 0xF000
    ctx->pc = 0x10e728u;
    SET_GPR_VEC(ctx, 2, PS2_POR(GPR_VEC(ctx, 2), _mm_cvtsi32_si128((int)61440u)));
    // 0x10e72c: 0xac430000  sw          $v1, 0x0($v0)
    ctx->pc = 0x10e72cu;
    runtime->Store32(rdram, ctx, ADD32(GPR_U32(ctx, 2), 0), GPR_U32(ctx, 3)); // MMIO: 0x10000000
label_10e730:
    // 0x10e730: 0x3c021001  lui         $v0, 0x1001
    ctx->pc = 0x10e730u;
    SET_GPR_S32(ctx, 2, (int32_t)((uint32_t)4097 << 16));
    // 0x10e734: 0x8c42f000  lw          $v0, -0x1000($v0)
    ctx->pc = 0x10e734u;
    SET_GPR_S32(ctx, 2, (int32_t)runtime->Load32(rdram, ctx, ADD32(GPR_U32(ctx, 2), 4294963200))); // MMIO: 0x1000f000
    // 0x10e738: 0x30420004  andi        $v0, $v0, 0x4
    ctx->pc = 0x10e738u;
    ...
    ctx->pc = 0x10e744u;
    // NOP
    // 0x10e748: 0x1040fff9  beqz        $v0, . + 4 + (-0x7 << 2)
    ctx->pc = 0x10E748u;
    {
        const bool branch_taken_0x10e748 = (GPR_U64(ctx, 2) == GPR_U64(ctx, 0));
    ...
    ctx->pc = 0x10E750u;
    // 0x10e750: 0x24020004  addiu       $v0, $zero, 0x4
    ctx->pc = 0x10e750u;
    SET_GPR_S32(ctx, 2, (int32_t)ADD32(GPR_U32(ctx, 0), 4));
    // 0x10e754: 0x3c011001  lui         $at, 0x1001
    ctx->pc = 0x10e754u;
    SET_GPR_S32(ctx, 1, (int32_t)((uint32_t)4097 << 16));
    // 0x10e758: 0x3e00008  jr          $ra
    ctx->pc = 0x10E758u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x10E75Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x10E758u;
            // 0x10e75c: 0xac22f000  sw          $v0, -0x1000($at) (Delay Slot)
