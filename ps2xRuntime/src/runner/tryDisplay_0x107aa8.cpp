...
void tryDisplay_0x107aa8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    // 0x107ab4: 0x3c120014
    ctx->pc = 0x107ab4u;
    SET_GPR_U32(ctx, 18, ((uint32_t)20 << 16));
    // 0x107ab8: 0xffbf0040
    ctx->pc = 0x107ab8u;
    ...
    *(int32_t*)&ctx->f[0] = FPU_CVT_W_S(ctx->f[1]);
    ...
    // 0x107b30: 0x3c107f00
    ctx->pc = 0x107b30u;
    SET_GPR_U32(ctx, 16, ((uint32_t)32512 << 16));
    // 0x107b34: 0x922b05bc
    ctx->pc = 0x107b34u;
    ...
    // 0x107b3c: 0x361080ff
    ctx->pc = 0x107b3cu;
    SET_GPR_U32(ctx, 16, OR32(GPR_U32(ctx, 16), 33023));
    // 0x107b40: 0x46030842
    ctx->pc = 0x107b40u;
    ctx->f[1] = FPU_MUL_S(ctx->f[1], ctx->f[3]);
    // 0x107b44: 0x8e240594
...
label_107c78:
    ...
    // 0x107c88: 0x3c117f00
    ctx->pc = 0x107c88u;
    SET_GPR_U32(ctx, 17, ((uint32_t)32512 << 16));
    // 0x107c8c: 0xc6000300
    ctx->pc = 0x107c8cu;
    ...
    // 0x107ca8: 0x363180ff
    ctx->pc = 0x107ca8u;
    SET_GPR_U32(ctx, 17, OR32(GPR_U32(ctx, 17), 33023));
    // 0x107cac: 0x46020002
    ctx->pc = 0x107cacu;
    ctx->f[0] = FPU_MUL_S(ctx->f[0], ctx->f[2]);
    // 0x107cb0: 0x8e0402ec
