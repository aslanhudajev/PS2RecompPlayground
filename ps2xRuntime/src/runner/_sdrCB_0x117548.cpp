...
#ifdef _DEBUG
    PS_LOG_ENTRY("_sdrCB_0x117548");
#endif

    ctx->pc = 0x117548u;

label_117548:
    // 0x117548: 0x27bdfff0  addiu       $sp, $sp, -0x10
    ctx->pc = 0x117548u;
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 4294967280));
label_11754c:
    // 0x11754c: 0xffbf0000  sd          $ra, 0x0($sp)
    ctx->pc = 0x11754cu;
    WRITE64(ADD32(GPR_U32(ctx, 29), 0), GPR_U64(ctx, 31));
label_117550:
    // 0x117550: 0x8ca20000  lw          $v0, 0x0($a1)
    ctx->pc = 0x117550u;
    SET_GPR_S32(ctx, 2, (int32_t)READ32(ADD32(GPR_U32(ctx, 5), 0)));
label_117554:
    // 0x117554: 0x2444ffff  addiu       $a0, $v0, -0x1
    ctx->pc = 0x117554u;
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 2), 4294967295));
label_117558:
    // 0x117558: 0x2c83000d  sltiu       $v1, $a0, 0xD
    ctx->pc = 0x117558u;
    SET_GPR_U64(ctx, 3, ((uint64_t)GPR_U64(ctx, 4) < (uint64_t)(int64_t)(int32_t)13) ? 1 : 0);
label_11755c:
    // 0x11755c: 0x1060002e  beqz        $v1, . + 4 + (0x2E << 2)
label_117560:
    if (ctx->pc == 0x117560u) {
        ctx->pc = 0x117560u;
            // 0x117560: 0x3c020017  lui         $v0, 0x17 (Delay Slot)
    ...
    ctx->pc = 0x11755Cu;
    {
        const bool branch_taken_0x11755c = (GPR_U64(ctx, 3) == GPR_U64(ctx, 0));
        ctx->pc = 0x117560u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x11755Cu;
            // 0x117560: 0x3c020017  lui         $v0, 0x17 (Delay Slot)
        SET_GPR_S32(ctx, 2, (int32_t)((uint32_t)23 << 16));
    ...
    ctx->pc = 0x117564u;
label_117564:
    // 0x117564: 0x41880  sll         $v1, $a0, 2
    ctx->pc = 0x117564u;
    SET_GPR_S32(ctx, 3, (int32_t)SLL32(GPR_U32(ctx, 4), 2));
label_117568:
    // 0x117568: 0x244241e0  addiu       $v0, $v0, 0x41E0
    ctx->pc = 0x117568u;
    SET_GPR_S32(ctx, 2, (int32_t)ADD32(GPR_U32(ctx, 2), 16864));
label_11756c:
    // 0x11756c: 0x621821  addu        $v1, $v1, $v0
    ctx->pc = 0x11756cu;
    SET_GPR_S32(ctx, 3, (int32_t)ADD32(GPR_U32(ctx, 3), GPR_U32(ctx, 2)));
label_117570:
    // 0x117570: 0x8c640000  lw          $a0, 0x0($v1)
    ctx->pc = 0x117570u;
    SET_GPR_S32(ctx, 4, (int32_t)READ32(ADD32(GPR_U32(ctx, 3), 0)));
label_117574:
    // 0x117574: 0x800008  jr          $a0
label_117578:
    if (ctx->pc == 0x117578u) {
        ctx->pc = 0x11757Cu;
        goto label_11757c;
    ...
    ctx->pc = 0x11757Cu;
label_11757c:
    // 0x11757c: 0x3c020017  lui         $v0, 0x17
    ctx->pc = 0x11757cu;
    SET_GPR_S32(ctx, 2, (int32_t)((uint32_t)23 << 16));
label_117580:
    // 0x117580: 0x10000006  b           . + 4 + (0x6 << 2)
label_117584:
    if (ctx->pc == 0x117584u) {
        ctx->pc = 0x117584u;
            // 0x117584: 0x8c42fc3c  lw          $v0, -0x3C4($v0) (Delay Slot)
        SET_GPR_S32(ctx, 2, (int32_t)READ32(ADD32(GPR_U32(ctx, 2), 4294966332)));
        ctx->pc = 0x117588u;
        goto label_117588;
    }
    ctx->pc = 0x117580u;
    {
        const bool branch_taken_0x117580 = (GPR_U64(ctx, 0) == GPR_U64(ctx, 0));
        ctx->pc = 0x117584u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x117580u;
            // 0x117584: 0x8c42fc3c  lw          $v0, -0x3C4($v0) (Delay Slot)
        SET_GPR_S32(ctx, 2, (int32_t)READ32(ADD32(GPR_U32(ctx, 2), 4294966332)));
        ctx->in_delay_slot = false;
    ...
    ctx->pc = 0x117588u;
label_117588:
    // 0x117588: 0x3c020017  lui         $v0, 0x17
    ctx->pc = 0x117588u;
    SET_GPR_S32(ctx, 2, (int32_t)((uint32_t)23 << 16));
label_11758c:
    // 0x11758c: 0x10000003  b           . + 4 + (0x3 << 2)
label_117590:
    if (ctx->pc == 0x117590u) {
        ctx->pc = 0x117590u;
            // 0x117590: 0x8c42fc40  lw          $v0, -0x3C0($v0) (Delay Slot)
        SET_GPR_S32(ctx, 2, (int32_t)READ32(ADD32(GPR_U32(ctx, 2), 4294966336)));
        ctx->pc = 0x117594u;
        goto label_117594;
    }
    ctx->pc = 0x11758Cu;
    {
        const bool branch_taken_0x11758c = (GPR_U64(ctx, 0) == GPR_U64(ctx, 0));
        ctx->pc = 0x117590u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x11758Cu;
            // 0x117590: 0x8c42fc40  lw          $v0, -0x3C0($v0) (Delay Slot)
        SET_GPR_S32(ctx, 2, (int32_t)READ32(ADD32(GPR_U32(ctx, 2), 4294966336)));
        ctx->in_delay_slot = false;
    ...
    ctx->pc = 0x117594u;
label_117594:
    // 0x117594: 0x3c020017  lui         $v0, 0x17
    ctx->pc = 0x117594u;
    SET_GPR_S32(ctx, 2, (int32_t)((uint32_t)23 << 16));
label_117598:
    // 0x117598: 0x8c42fc44  lw          $v0, -0x3BC($v0)
    ctx->pc = 0x117598u;
    SET_GPR_S32(ctx, 2, (int32_t)READ32(ADD32(GPR_U32(ctx, 2), 4294966340)));
label_11759c:
    // 0x11759c: 0x1040001f  beqz        $v0, . + 4 + (0x1F << 2)
label_1175a0:
    if (ctx->pc == 0x1175A0u) {
        ctx->pc = 0x1175A0u;
            // 0x1175a0: 0xdfbf0000  ld          $ra, 0x0($sp) (Delay Slot)
    ...
    ctx->pc = 0x11759Cu;
    {
        const bool branch_taken_0x11759c = (GPR_U64(ctx, 2) == GPR_U64(ctx, 0));
        ctx->pc = 0x1175A0u;
...
label_1175a8:
    ...
    ctx->pc = 0x1175ACu;
label_1175ac:
    // 0x1175ac: 0x1000001b  b           . + 4 + (0x1B << 2)
label_1175b0:
    if (ctx->pc == 0x1175B0u) {
        ctx->pc = 0x1175B0u;
            // 0x1175b0: 0xdfbf0000  ld          $ra, 0x0($sp) (Delay Slot)
        SET_GPR_U64(ctx, 31, READ64(ADD32(GPR_U32(ctx, 29), 0)));
        ctx->pc = 0x1175B4u;
        goto label_1175b4;
    }
    ctx->pc = 0x1175ACu;
    {
        ...
        ctx->pc = 0x1175B0u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1175ACu;
            // 0x1175b0: 0xdfbf0000  ld          $ra, 0x0($sp) (Delay Slot)
        SET_GPR_U64(ctx, 31, READ64(ADD32(GPR_U32(ctx, 29), 0)));
        ctx->in_delay_slot = false;
    ...
    ctx->pc = 0x1175B4u;
label_1175b4:
    // 0x1175b4: 0x3c020017  lui         $v0, 0x17
    ctx->pc = 0x1175b4u;
    SET_GPR_S32(ctx, 2, (int32_t)((uint32_t)23 << 16));
label_1175b8:
    // 0x1175b8: 0x8c43fc48  lw          $v1, -0x3B8($v0)
    ctx->pc = 0x1175b8u;
    SET_GPR_S32(ctx, 3, (int32_t)READ32(ADD32(GPR_U32(ctx, 2), 4294966344)));
label_1175bc:
    // 0x1175bc: 0x10600016  beqz        $v1, . + 4 + (0x16 << 2)
label_1175c0:
    if (ctx->pc == 0x1175C0u) {
        ctx->pc = 0x1175C0u;
            // 0x1175c0: 0x3c020017  lui         $v0, 0x17 (Delay Slot)
        SET_GPR_S32(ctx, 2, (int32_t)((uint32_t)23 << 16));
        ctx->pc = 0x1175C4u;
        goto label_1175c4;
    }
    ctx->pc = 0x1175BCu;
    {
        const bool branch_taken_0x1175bc = (GPR_U64(ctx, 3) == GPR_U64(ctx, 0));
        ctx->pc = 0x1175C0u;
    ...
    ctx->pc = 0x1175C4u;
label_1175c4:
    // 0x1175c4: 0x202d  daddu       $a0, $zero, $zero
    ctx->pc = 0x1175c4u;
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
label_1175c8:
    // 0x1175c8: 0x60f809  jalr        $v1
label_1175cc:
    if (ctx->pc == 0x1175CCu) {
        ctx->pc = 0x1175CCu;
            // 0x1175cc: 0x8c45fc54  lw          $a1, -0x3AC($v0) (Delay Slot)
        SET_GPR_S32(ctx, 5, (int32_t)READ32(ADD32(GPR_U32(ctx, 2), 4294966356)));
        ctx->pc = 0x1175D0u;
        goto label_1175d0;
    }
    ctx->pc = 0x1175C8u;
    {
        ...
        ctx->pc = 0x1175CCu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1175C8u;
            // 0x1175cc: 0x8c45fc54  lw          $a1, -0x3AC($v0) (Delay Slot)
        SET_GPR_S32(ctx, 5, (int32_t)READ32(ADD32(GPR_U32(ctx, 2), 4294966356)));
        ctx->in_delay_slot = false;
        ctx->pc = jumpTarget;
    ...
    ctx->pc = 0x1175D0u;
label_1175d0:
    // 0x1175d0: 0x10000012  b           . + 4 + (0x12 << 2)
label_1175d4:
    if (ctx->pc == 0x1175D4u) {
        ctx->pc = 0x1175D4u;
            // 0x1175d4: 0xdfbf0000  ld          $ra, 0x0($sp) (Delay Slot)
        SET_GPR_U64(ctx, 31, READ64(ADD32(GPR_U32(ctx, 29), 0)));
        ctx->pc = 0x1175D8u;
        goto label_1175d8;
    }
    ...
    ctx->pc = 0x1175D8u;
label_1175d8:
    // 0x1175d8: 0x3c020017  lui         $v0, 0x17
    ctx->pc = 0x1175d8u;
    SET_GPR_S32(ctx, 2, (int32_t)((uint32_t)23 << 16));
label_1175dc:
    // 0x1175dc: 0x8c43fc4c  lw          $v1, -0x3B4($v0)
    ctx->pc = 0x1175dcu;
    SET_GPR_S32(ctx, 3, (int32_t)READ32(ADD32(GPR_U32(ctx, 2), 4294966348)));
label_1175e0:
    // 0x1175e0: 0x1060000d  beqz        $v1, . + 4 + (0xD << 2)
label_1175e4:
    if (ctx->pc == 0x1175E4u) {
        ctx->pc = 0x1175E4u;
            // 0x1175e4: 0x3c020017  lui         $v0, 0x17 (Delay Slot)
        SET_GPR_S32(ctx, 2, (int32_t)((uint32_t)23 << 16));
        ctx->pc = 0x1175E8u;
        goto label_1175e8;
    }
    ctx->pc = 0x1175E0u;
    {
        const bool branch_taken_0x1175e0 = (GPR_U64(ctx, 3) == GPR_U64(ctx, 0));
        ctx->pc = 0x1175E4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1175E0u;
            // 0x1175e4: 0x3c020017  lui         $v0, 0x17 (Delay Slot)
        SET_GPR_S32(ctx, 2, (int32_t)((uint32_t)23 << 16));
        ctx->in_delay_slot = false;
    ...
    ctx->pc = 0x1175E8u;
label_1175e8:
    // 0x1175e8: 0x24040001  addiu       $a0, $zero, 0x1
    ctx->pc = 0x1175e8u;
    SET_GPR_S32(ctx, 4, (int32_t)ADD32(GPR_U32(ctx, 0), 1));
label_1175ec:
    // 0x1175ec: 0x60f809  jalr        $v1
label_1175f0:
    if (ctx->pc == 0x1175F0u) {
        ctx->pc = 0x1175F0u;
            // 0x1175f0: 0x8c45fc58  lw          $a1, -0x3A8($v0) (Delay Slot)
        SET_GPR_S32(ctx, 5, (int32_t)READ32(ADD32(GPR_U32(ctx, 2), 4294966360)));
        ctx->pc = 0x1175F4u;
        goto label_1175f4;
    }
    ctx->pc = 0x1175ECu;
    ...
    ctx->pc = 0x1175F4u;
label_1175f4:
    // 0x1175f4: 0x10000009  b           . + 4 + (0x9 << 2)
label_1175f8:
    if (ctx->pc == 0x1175F8u) {
        ctx->pc = 0x1175F8u;
            // 0x1175f8: 0xdfbf0000  ld          $ra, 0x0($sp) (Delay Slot)
        SET_GPR_U64(ctx, 31, READ64(ADD32(GPR_U32(ctx, 29), 0)));
        ctx->pc = 0x1175FCu;
        goto label_1175fc;
    }
    ctx->pc = 0x1175F4u;
    {
        const bool branch_taken_0x1175f4 = (GPR_U64(ctx, 0) == GPR_U64(ctx, 0));
        ctx->pc = 0x1175F8u;
    ...
    ctx->pc = 0x1175FCu;
label_1175fc:
    // 0x1175fc: 0x3c020017  lui         $v0, 0x17
    ctx->pc = 0x1175fcu;
    SET_GPR_S32(ctx, 2, (int32_t)((uint32_t)23 << 16));
label_117600:
    // 0x117600: 0x8c43fc50  lw          $v1, -0x3B0($v0)
    ctx->pc = 0x117600u;
    SET_GPR_S32(ctx, 3, (int32_t)READ32(ADD32(GPR_U32(ctx, 2), 4294966352)));
label_117604:
    // 0x117604: 0x10600004  beqz        $v1, . + 4 + (0x4 << 2)
label_117608:
    if (ctx->pc == 0x117608u) {
        ctx->pc = 0x117608u;
            // 0x117608: 0x3c020017  lui         $v0, 0x17 (Delay Slot)
        SET_GPR_S32(ctx, 2, (int32_t)((uint32_t)23 << 16));
        ctx->pc = 0x11760Cu;
        goto label_11760c;
    }
    ctx->pc = 0x117604u;
    {
        const bool branch_taken_0x117604 = (GPR_U64(ctx, 3) == GPR_U64(ctx, 0));
        ctx->pc = 0x117608u;
    ...
    ctx->pc = 0x11760Cu;
label_11760c:
    // 0x11760c: 0x8ca40004  lw          $a0, 0x4($a1)
    ctx->pc = 0x11760cu;
    SET_GPR_S32(ctx, 4, (int32_t)READ32(ADD32(GPR_U32(ctx, 5), 4)));
label_117610:
    // 0x117610: 0x60f809  jalr        $v1
label_117614:
    if (ctx->pc == 0x117614u) {
        ctx->pc = 0x117614u;
            // 0x117614: 0x8c45fc5c  lw          $a1, -0x3A4($v0) (Delay Slot)
        SET_GPR_S32(ctx, 5, (int32_t)READ32(ADD32(GPR_U32(ctx, 2), 4294966364)));
        ctx->pc = 0x117618u;
        goto label_117618;
    }
    ctx->pc = 0x117610u;
...
label_117618:
    ...
    SET_GPR_U64(ctx, 31, READ64(ADD32(GPR_U32(ctx, 29), 0)));
label_11761c:
    // 0x11761c: 0x102d  daddu       $v0, $zero, $zero
    ctx->pc = 0x11761cu;
...
label_117624:
    if (ctx->pc == 0x117624u) {
        ctx->pc = 0x117624u;
            // 0x117624: 0x27bd0010  addiu       $sp, $sp, 0x10 (Delay Slot)
