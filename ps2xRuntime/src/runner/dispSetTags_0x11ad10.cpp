...
void dispSetTags_0x11ad10(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    // 0x11ad14: 0x3c0d0fff
    ctx->pc = 0x11ad14u;
    SET_GPR_S32(ctx, 13, ((uint32_t)4095 << 16));
    // 0x11ad18: 0xffbe0100
    ctx->pc = 0x11ad18u;
    WRITE64(ADD32(GPR_U32(ctx, 29), 256), GPR_U64(ctx, 30));
    // 0x11ad1c: 0x35adffff
    ctx->pc = 0x11ad1cu;
    SET_GPR_U64(ctx, 13, GPR_U64(ctx, 13) | (uint64_t)65535);
    // 0x11ad20: 0xffb500d0
    ctx->pc = 0x11ad20u;
    ...
    // 0x11ada4: 0xa26825
    ctx->pc = 0x11ada4u;
    SET_GPR_U64(ctx, 13, GPR_U64(ctx, 5) | GPR_U64(ctx, 2));
    // 0x11ada8: 0x140602d
    ctx->pc = 0x11ada8u;
...
label_11aed0:
    ...
    // 0x11af58: 0x3c060fff
    ctx->pc = 0x11af58u;
    SET_GPR_S32(ctx, 6, ((uint32_t)4095 << 16));
    // 0x11af5c: 0x40202d
    ctx->pc = 0x11af5cu;
    SET_GPR_U64(ctx, 4, (uint64_t)GPR_U64(ctx, 2) + (uint64_t)GPR_U64(ctx, 0));
    // 0x11af60: 0x34c6ffff
    ctx->pc = 0x11af60u;
    SET_GPR_U64(ctx, 6, GPR_U64(ctx, 6) | (uint64_t)65535);
    // 0x11af64: 0x282d
    ctx->pc = 0x11af64u;
    SET_GPR_U64(ctx, 5, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
    // 0x11af68: 0x2663024
