...
void MBEndFrame_0x2c5e68(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    printf("[MBEndFrame #%d] ENTRY  ra=0x%x sp=0x%x\n", _call, GPR_U32(ctx, 31), GPR_U32(ctx, 29));
    ...
    // 0x2c5e98: 0xc0b01ec  call pbDmaWaitFinished
    ctx->pc = 0x2C5E98u;
    SET_GPR_U32(ctx, 31, 0x2C5EA0u);
    ctx->pc = 0x2C5E9Cu;
    WRITE32(ADD32(GPR_U32(ctx, 4), 4), GPR_U32(ctx, 2));
    printf("[MBEndFrame #%d] BEFORE pbDmaWaitFinished  s2=0x%x  a0=*(s2+0x2c)=0x%x  *(a0+4)=0x%x (masked)  a0=0x%x\n",
           _call, GPR_U32(ctx, 18), GPR_U32(ctx, 4), GPR_U32(ctx, 2), GPR_U32(ctx, 4));
    ctx->pc = 0x2C07B0u;
    {
    ...
    ctx->pc = 0x2C5EA0u;
    printf("[MBEndFrame #%d] AFTER pbDmaWaitFinished   v0=0x%x  s2=0x%x  continuing...\n", _call, GPR_U32(ctx, 2), GPR_U32(ctx, 18));
    // 0x2c5ea0: 0xc0a92b6
    ctx->pc = 0x2C5EA0u;
