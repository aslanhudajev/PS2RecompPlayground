...
void _rix_111_0x122488(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
#ifdef _DEBUG
    PS_LOG_ENTRY("_rix_111_0x122488");
#endif

    ctx->pc = 0x122488u;

    // 0x122488: 0x7000cce9  pnor        $t9, $zero, $zero
    ctx->pc = 0x122488u;
    SET_GPR_VEC(ctx, 25, PS2_PNOR(GPR_VEC(ctx, 0), GPR_VEC(ctx, 0)));
    // 0x12248c: 0x7019cbf6  psrlh       $t9, $t9, 15
    ctx->pc = 0x12248cu;
    SET_GPR_VEC(ctx, 25, _mm_srli_epi16(GPR_VEC(ctx, 25), 15));
    // 0x122490: 0x7019c874  psllh       $t9, $t9, 1
    ctx->pc = 0x122490u;
    SET_GPR_VEC(ctx, 25, _mm_slli_epi16(GPR_VEC(ctx, 25), 1));
    // 0x122494: 0x8c850014  lw          $a1, 0x14($a0)
    ctx->pc = 0x122494u;
    SET_GPR_S32(ctx, 5, (int32_t)READ32(ADD32(GPR_U32(ctx, 4), 20)));
    // 0x122498: 0x8c860018  lw          $a2, 0x18($a0)
    ctx->pc = 0x122498u;
    SET_GPR_S32(ctx, 6, (int32_t)READ32(ADD32(GPR_U32(ctx, 4), 24)));
    // 0x12249c: 0x8c870008  lw          $a3, 0x8($a0)
    ctx->pc = 0x12249cu;
    SET_GPR_S32(ctx, 7, (int32_t)READ32(ADD32(GPR_U32(ctx, 4), 8)));
    // 0x1224a0: 0x8c8e0000  lw          $t6, 0x0($a0)
    ctx->pc = 0x1224a0u;
    SET_GPR_S32(ctx, 14, (int32_t)READ32(ADD32(GPR_U32(ctx, 4), 0)));
    // 0x1224a4: 0x8c8d0004  lw          $t5, 0x4($a0)
    ctx->pc = 0x1224a4u;
    SET_GPR_S32(ctx, 13, (int32_t)READ32(ADD32(GPR_U32(ctx, 4), 4)));
    // 0x1224a8: 0x8c980010  lw          $t8, 0x10($a0)
    ctx->pc = 0x1224a8u;
    SET_GPR_S32(ctx, 24, (int32_t)READ32(ADD32(GPR_U32(ctx, 4), 16)));
    // 0x1224ac: 0x240c0001  addiu       $t4, $zero, 0x1
    ctx->pc = 0x1224acu;
    SET_GPR_S32(ctx, 12, (int32_t)ADD32(GPR_U32(ctx, 0), 1));
    // 0x1224b0: 0x78a80000  lq          $t0, 0x0($a1)
    ctx->pc = 0x1224b0u;
    SET_GPR_VEC(ctx, 8, READ128(ADD32(GPR_U32(ctx, 5), 0)));
    // 0x1224b4: 0x78c90000  lq          $t1, 0x0($a2)
    ctx->pc = 0x1224b4u;
    SET_GPR_VEC(ctx, 9, READ128(ADD32(GPR_U32(ctx, 6), 0)));
    // 0x1224b8: 0x5b80000  mtsab       $t5, 0x0
    ctx->pc = 0x1224b8u;
    ctx->sa = ((GPR_U32(ctx, 13) ^ (uint32_t)0) & 0xF) << 3;
    // 0x1224bc: 0x712856e8  qfsrv       $t2, $t1, $t0
    ctx->pc = 0x1224bcu;
    { 
    ...
    // 0x1224c0: 0x71097ee8  qfsrv       $t7, $t0, $t1
    ctx->pc = 0x1224c0u;
    { 
    ...
    // 0x1224c4: 0x700a4688  pextlb      $t0, $zero, $t2
    ctx->pc = 0x1224c4u;
    SET_GPR_VEC(ctx, 8, PS2_PEXTLB(GPR_VEC(ctx, 0), GPR_VEC(ctx, 10)));
    // 0x1224c8: 0x700a4ea8  pextub      $t1, $zero, $t2
    ctx->pc = 0x1224c8u;
    SET_GPR_VEC(ctx, 9, PS2_PEXTUB(GPR_VEC(ctx, 0), GPR_VEC(ctx, 10)));
    // 0x1224cc: 0x240bffff  addiu       $t3, $zero, -0x1
    ctx->pc = 0x1224ccu;
    SET_GPR_S32(ctx, 11, (int32_t)ADD32(GPR_U32(ctx, 0), 4294967295));
    // 0x1224d0: 0x5980000  mtsab       $t4, 0x0
    ctx->pc = 0x1224d0u;
    ctx->sa = ((GPR_U32(ctx, 12) ^ (uint32_t)0) & 0xF) << 3;
    // 0x1224d4: 0x71ea7ee8  qfsrv       $t7, $t7, $t2
    ctx->pc = 0x1224d4u;
    { 
    ...
    // 0x1224d8: 0x700f5688  pextlb      $t2, $zero, $t7
    ctx->pc = 0x1224d8u;
    SET_GPR_VEC(ctx, 10, PS2_PEXTLB(GPR_VEC(ctx, 0), GPR_VEC(ctx, 15)));
    // 0x1224dc: 0x700f7ea8  pextub      $t7, $zero, $t7
    ctx->pc = 0x1224dcu;
    SET_GPR_VEC(ctx, 15, PS2_PEXTUB(GPR_VEC(ctx, 0), GPR_VEC(ctx, 15)));
    // 0x1224e0: 0x710a4108  paddh       $t0, $t0, $t2
    ctx->pc = 0x1224e0u;
    SET_GPR_VEC(ctx, 8, PS2_PADDH(GPR_VEC(ctx, 8), GPR_VEC(ctx, 10)));
    // 0x1224e4: 0x10e0002a  beqz        $a3, . + 4 + (0x2A << 2)
    ctx->pc = 0x1224E4u;
    {
        const bool branch_taken_0x1224e4 = (GPR_U64(ctx, 7) == GPR_U64(ctx, 0));
        ctx->pc = 0x1224E8u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1224E4u;
            // 0x1224e8: 0x712f4908  paddh       $t1, $t1, $t7 (Delay Slot)
...
label_1224ec:
    ...
    // 0x122504: 0x714f1ee8  qfsrv       $v1, $t2, $t7
    ctx->pc = 0x122504u;
    { 
    ...
    // 0x122508: 0x70025688  pextlb      $t2, $zero, $v0
    ctx->pc = 0x122508u;
    SET_GPR_VEC(ctx, 10, PS2_PEXTLB(GPR_VEC(ctx, 0), GPR_VEC(ctx, 2)));
    // 0x12250c: 0x20e7ffff  addi        $a3, $a3, -0x1
    ctx->pc = 0x12250cu;
    { uint32_t tmp; bool ov; ADD32_OV(GPR_U32(ctx, 7), (int32_t)4294967295, tmp, ov); if (ov) runtime->SignalException(ctx, EXCEPTION_INTEGER_OVERFLOW); else SET_GPR_S32(ctx, 7, (int32_t)tmp); }
    // 0x122510: 0x70027ea8  pextub      $t7, $zero, $v0
    ctx->pc = 0x122510u;
    SET_GPR_VEC(ctx, 15, PS2_PEXTUB(GPR_VEC(ctx, 0), GPR_VEC(ctx, 2)));
    // 0x122514: 0x5980000  mtsab       $t4, 0x0
    ctx->pc = 0x122514u;
    ctx->sa = ((GPR_U32(ctx, 12) ^ (uint32_t)0) & 0xF) << 3;
    // 0x122518: 0x70621ee8  qfsrv       $v1, $v1, $v0
    ctx->pc = 0x122518u;
    { 
    ...
    ctx->pc = 0x122590u;
label_122590:
    // 0x122590: 0x24a50080  addiu       $a1, $a1, 0x80
    ctx->pc = 0x122590u;
    SET_GPR_S32(ctx, 5, (int32_t)ADD32(GPR_U32(ctx, 5), 128));
    // 0x122594: 0x24c60080  addiu       $a2, $a2, 0x80
    ctx->pc = 0x122594u;
    SET_GPR_S32(ctx, 6, (int32_t)ADD32(GPR_U32(ctx, 6), 128));
    // 0x122598: 0x8c87000c  lw          $a3, 0xC($a0)
    ctx->pc = 0x122598u;
    SET_GPR_S32(ctx, 7, (int32_t)READ32(ADD32(GPR_U32(ctx, 4), 12)));
    // 0x12259c: 0x1675024  and         $t2, $t3, $a3
    ctx->pc = 0x12259cu;
    SET_GPR_VEC(ctx, 10, PS2_PAND(GPR_VEC(ctx, 11), GPR_VEC(ctx, 7)));
    // 0x1225a0: 0x1540ffd2  bnez        $t2, . + 4 + (-0x2E << 2)
    ctx->pc = 0x1225A0u;
    {
        const bool branch_taken_0x1225a0 = (GPR_U64(ctx, 10) != GPR_U64(ctx, 0));
        ctx->pc = 0x1225A4u;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1225A0u;
            // 0x1225a4: 0x582d  daddu       $t3, $zero, $zero (Delay Slot)
