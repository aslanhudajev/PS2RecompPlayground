...
void _decMB0_0x123170(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    // 0x12317c: 0x3c0b1000
    ctx->pc = 0x12317cu;
    SET_GPR_S32(ctx, 11, ((uint32_t)4096 << 16));
    // 0x123180: 0xffb50070
    ctx->pc = 0x123180u;
    WRITE64(ADD32(GPR_U32(ctx, 29), 112), GPR_U64(ctx, 21));
    // 0x123184: 0x356b2010
    ctx->pc = 0x123184u;
    SET_GPR_U64(ctx, 11, GPR_U64(ctx, 11) | (uint64_t)8208);
    // 0x123188: 0xffb20040
    ctx->pc = 0x123188u;
    ...
    // 0x1231c4: 0x3c02f8ff
    ctx->pc = 0x1231c4u;
    SET_GPR_S32(ctx, 2, ((uint32_t)63743 << 16));
    // 0x1231c8: 0x3442ffff
    ctx->pc = 0x1231c8u;
...
label_1234bc:
    ...
    // 0x1234d8: 0x3c0a8000
    ctx->pc = 0x1234d8u;
    SET_GPR_S32(ctx, 10, ((uint32_t)32768 << 16));
    // 0x1234dc: 0x3c061000
    ctx->pc = 0x1234dcu;
    ...
    // 0x1234e4: 0x34c6b010
    ctx->pc = 0x1234e4u;
    SET_GPR_U64(ctx, 6, GPR_U64(ctx, 6) | (uint64_t)45072);
    // 0x1234e8: 0x24090030
    ctx->pc = 0x1234e8u;
