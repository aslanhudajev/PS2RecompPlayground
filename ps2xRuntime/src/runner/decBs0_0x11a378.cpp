...
label_11a3c8:
    ...
    // 0x11a3d0: 0x3c030075
    ctx->pc = 0x11a3d0u;
    SET_GPR_U32(ctx, 3, ((uint32_t)117 << 16));
label_11a3d4:
    // 0x11a3d4: 0xc046a6e
    ctx->pc = 0x11A3D4u;
...
label_11a408:
    ...
    *(uint32_t*)&ctx->f[22] = GPR_U32(ctx, 30);
    ...
    // 0x11a448: 0x3c0143f0
    ctx->pc = 0x11a448u;
    SET_GPR_U32(ctx, 1, ((uint32_t)17392 << 16));
    // 0x11a44c: 0x44810000
    ctx->pc = 0x11a44cu;
    *(uint32_t*)&ctx->f[0] = GPR_U32(ctx, 1);
    // 0x11a450: 0x10400003
...
label_11a460:
    ...
    // 0x11a474: 0x3405ffa0
    ctx->pc = 0x11a474u;
    SET_GPR_U32(ctx, 5, OR32(GPR_U32(ctx, 0), 65440));
    // 0x11a478: 0x52bbc
    ctx->pc = 0x11a478u;
...
label_11a50c:
    ...
    // 0x11a534: 0x3c120002
    ctx->pc = 0x11a534u;
    SET_GPR_U32(ctx, 18, ((uint32_t)2 << 16));
    // 0x11a538: 0xa82d
    ctx->pc = 0x11a538u;
    SET_GPR_U64(ctx, 21, (uint64_t)GPR_U64(ctx, 0) + (uint64_t)GPR_U64(ctx, 0));
    // 0x11a53c: 0x36522340
    ctx->pc = 0x11a53cu;
    SET_GPR_U32(ctx, 18, OR32(GPR_U32(ctx, 18), 9024));
    // 0x11a540: 0x982d
    ctx->pc = 0x11a540u;
...
label_11a548:
    ...
    // 0x11a5e4: 0x3c050075
    ctx->pc = 0x11a5e4u;
    SET_GPR_U32(ctx, 5, ((uint32_t)117 << 16));
    // 0x11a5e8: 0x3c020016
    ctx->pc = 0x11a5e8u;
    ...
    // 0x11a5fc: 0x3463af40
    ctx->pc = 0x11a5fcu;
    SET_GPR_U32(ctx, 3, OR32(GPR_U32(ctx, 3), 44864));
    // 0x11a600: 0x2a2a821
    ctx->pc = 0x11a600u;
