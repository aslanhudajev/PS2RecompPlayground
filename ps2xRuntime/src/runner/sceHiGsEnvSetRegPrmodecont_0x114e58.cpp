...
// Ghidra: env+8=innerPtr, env+12=mask. Mask bit 8 -> slot. RMW LSB: old & ~1 | (a1 & 1).
void sceHiGsEnvSetRegPrmodecont_0x114e58(uint8_t* rdram, R5900Context* ctx, PS2Runtime* runtime) {
#ifdef _DEBUG
    PS_LOG_ENTRY("sceHiGsEnvSetRegPrmodecont_0x114e58");
#endif
    ...
    constexpr uint32_t kBitIndex = 8u;
