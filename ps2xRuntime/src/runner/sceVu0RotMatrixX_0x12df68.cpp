...
// Ghidra decomp: angle from $f12, transform range, build Rx matrix
void sceVu0RotMatrixX_0x12df68(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
#ifdef _DEBUG
    PS_LOG_ENTRY("sceVu0RotMatrixX_0x12df68");
#endif
    (void)runtime;
