...
void hextoint_0x1029d8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    ctx->pc = 0x1029DCu;
    {
        const bool branch_taken_0x1029dc = (GPR_U32(ctx, 3) == GPR_U32(ctx, 0));
        ctx->pc = 0x1029E0u;
...
label_1029e8:
    ...
    ctx->pc = 0x1029ECu;
    {
        const bool branch_taken_0x1029ec = (GPR_U32(ctx, 2) == GPR_U32(ctx, 0));
        ctx->pc = 0x1029F0u;
    ...
    ctx->pc = 0x1029F8u;
    {
        const bool branch_taken_0x1029f8 = (GPR_U32(ctx, 0) == GPR_U32(ctx, 0));
        ctx->pc = 0x1029FCu;
...
label_102a00:
    ...
    ctx->pc = 0x102A08u;
    {
        const bool branch_taken_0x102a08 = (GPR_U32(ctx, 2) == GPR_U32(ctx, 0));
        ctx->pc = 0x102A0Cu;
    ...
    ctx->pc = 0x102A10u;
    {
        const bool branch_taken_0x102a10 = (GPR_U32(ctx, 0) == GPR_U32(ctx, 0));
        ctx->pc = 0x102A14u;
        SET_GPR_U32(ctx, 3, (uint8_t)READ8(ADD32(GPR_U32(ctx, 4), 0)));
...
label_102a18:
    ...
    ctx->pc = 0x102A20u;
    {
        const bool branch_taken_0x102a20 = (GPR_U32(ctx, 2) == GPR_U32(ctx, 0));
        ctx->pc = 0x102A24u;
...
label_102a30:
    ...
    ctx->pc = 0x102A38u;
    {
        const bool branch_taken_0x102a38 = (GPR_U32(ctx, 3) != GPR_U32(ctx, 0));
        ctx->pc = 0x102A3Cu;
        SET_GPR_S32(ctx, 2, ADD32(GPR_U32(ctx, 3), 4294967199));
