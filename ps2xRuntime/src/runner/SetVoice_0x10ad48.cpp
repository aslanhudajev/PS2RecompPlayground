...
label_10ad80:
    ...
    // 0x10ad88: 0xc28025
    ctx->pc = 0x10ad88u;
    SET_GPR_U64(ctx, 16, GPR_U64(ctx, 6) | GPR_U64(ctx, 2));
    // 0x10ad8c: 0x34058010
    ctx->pc = 0x10ad8cu;
...
label_10adb8:
    ...
    // 0x10adbc: 0x36060100
    ctx->pc = 0x10adbcu;
    SET_GPR_U64(ctx, 6, GPR_U64(ctx, 16) | (uint64_t)256);
    // 0x10adc0: 0xc045c80
    ctx->pc = 0x10ADC0u;
...
label_10ade0:
    ...
    ctx->pc = 0x10ADECu;
    SET_GPR_U64(ctx, 6, GPR_U64(ctx, 16) | (uint64_t)512);
    ctx->pc = 0x117200u;
    {
        const uint32_t __entryPc = ctx->pc;
        sceSdRemote_0x117200(rdram, ctx, runtime);
...
label_10ae08:
    ...
    // 0x10ae0c: 0x34058050
    ctx->pc = 0x10ae0cu;
    SET_GPR_U64(ctx, 5, GPR_U64(ctx, 0) | (uint64_t)32848);
    // 0x10ae10: 0xc045c80
    ctx->pc = 0x10AE10u;
    SET_GPR_U32(ctx, 31, 0x10AE18u);
    ctx->pc = 0x10AE14u;
    SET_GPR_U64(ctx, 6, GPR_U64(ctx, 16) | (uint64_t)8256);
    ctx->pc = 0x117200u;
    {
        const uint32_t __entryPc = ctx->pc;
        sceSdRemote_0x117200(rdram, ctx, runtime);
...
label_10ae30:
    ...
    // 0x10ae34: 0x36060300
    ctx->pc = 0x10ae34u;
    SET_GPR_U64(ctx, 6, GPR_U64(ctx, 16) | (uint64_t)768);
    // 0x10ae38: 0xc045c80
    ctx->pc = 0x10AE38u;
    ...
    ctx->pc = 0x10AE40u;
    {
        ...
        ctx->pc = 0x10AE44u;
        SET_GPR_U64(ctx, 6, GPR_U64(ctx, 16) | (uint64_t)1024);
