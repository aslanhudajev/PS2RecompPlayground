...
label_120a58:
    ...
    // 0x120a74: 0x3c0f0017
    ctx->pc = 0x120a74u;
    SET_GPR_S32(ctx, 15, ((uint32_t)23 << 16));
    // 0x120a78: 0x3c190017
    ctx->pc = 0x120a78u;
    SET_GPR_S32(ctx, 25, ((uint32_t)23 << 16));
    // 0x120a7c: 0x0
    ctx->pc = 0x120a7cu;
    // NOP
label_120a80:
    ...
    // 0x120a84: 0x3442d400
    ctx->pc = 0x120a84u;
    SET_GPR_U64(ctx, 2, GPR_U64(ctx, 2) | (uint64_t)54272);
    // 0x120a88: 0x8c430000
    ctx->pc = 0x120a88u;
...
label_120aec:
    ...
    // 0x120af8: 0x3c180017
    ctx->pc = 0x120af8u;
    SET_GPR_S32(ctx, 24, ((uint32_t)23 << 16));
    // 0x120afc: 0x3c0f0017
    ctx->pc = 0x120afcu;
    SET_GPR_S32(ctx, 15, ((uint32_t)23 << 16));
    // 0x120b00: 0x3c190017
...
label_120b08:
    ...
    // 0x120b4c: 0x3c052000
    ctx->pc = 0x120b4cu;
    SET_GPR_S32(ctx, 5, ((uint32_t)8192 << 16));
    // 0x120b50: 0x8c8d012c
    ctx->pc = 0x120b50u;
...
label_120b60:
    ...
    // 0x120b70: 0x3c070fff
    ctx->pc = 0x120b70u;
    SET_GPR_S32(ctx, 7, ((uint32_t)4095 << 16));
    // 0x120b74: 0x16e4026
    ctx->pc = 0x120b74u;
    ...
    // 0x120b84: 0x3c0a3000
    ctx->pc = 0x120b84u;
    SET_GPR_S32(ctx, 10, ((uint32_t)12288 << 16));
    // 0x120b88: 0x354a0030
    ctx->pc = 0x120b88u;
    SET_GPR_U64(ctx, 10, GPR_U64(ctx, 10) | (uint64_t)48);
    // 0x120b8c: 0x8280a
    ctx->pc = 0x120b8cu;
...
// In recompiled code, we don't need explicit memory barriers
    ...
    // 0x120bf4: 0x34e7d480
    ctx->pc = 0x120bf4u;
    SET_GPR_U64(ctx, 7, GPR_U64(ctx, 7) | (uint64_t)54400);
    // 0x120bf8: 0x3c081000
    ctx->pc = 0x120bf8u;
    ...
    // 0x120c00: 0x3508d430
    ctx->pc = 0x120c00u;
    SET_GPR_U64(ctx, 8, GPR_U64(ctx, 8) | (uint64_t)54320);
    // 0x120c04: 0x3c051000
    ctx->pc = 0x120c04u;
    ...
    // 0x120c0c: 0x34a5d420
    ctx->pc = 0x120c0cu;
    SET_GPR_U64(ctx, 5, GPR_U64(ctx, 5) | (uint64_t)54304);
    // 0x120c10: 0x34c6d400
    ctx->pc = 0x120c10u;
    SET_GPR_U64(ctx, 6, GPR_U64(ctx, 6) | (uint64_t)54272);
    // 0x120c14: 0x240a0105
    ctx->pc = 0x120c14u;
