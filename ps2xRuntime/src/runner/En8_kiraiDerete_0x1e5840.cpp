...
// Function: En8_kiraiDerete
// Address: 0x1e5840 - 0x1e5870
void En8_kiraiDerete_0x1e5840(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
#ifdef _DEBUG
    PS_LOG_ENTRY("En8_kiraiDerete_0x1e5840");
#endif

    ctx->pc = 0x1e5840u;

    // 0x1e5840: 0x27bdffe0  addiu       $sp, $sp, -0x20
    ctx->pc = 0x1e5840u;
    SET_GPR_S32(ctx, 29, (int32_t)ADD32(GPR_U32(ctx, 29), 4294967264));
    // 0x1e5844: 0xffbf0010  sd          $ra, 0x10($sp)
    ctx->pc = 0x1e5844u;
    WRITE64(ADD32(GPR_U32(ctx, 29), 16), GPR_U64(ctx, 31));
    // 0x1e5848: 0x7fb00000  sq          $s0, 0x0($sp)
    ctx->pc = 0x1e5848u;
    WRITE128(ADD32(GPR_U32(ctx, 29), 0), GPR_VEC(ctx, 16));
    // 0x1e584c: 0x80802d  daddu       $s0, $a0, $zero
    ctx->pc = 0x1e584cu;
    SET_GPR_U64(ctx, 16, (uint64_t)GPR_U64(ctx, 4) + (uint64_t)GPR_U64(ctx, 0));
    // 0x1e5850: 0xc060564  jal         func_181590
    ctx->pc = 0x1E5850u;
    SET_GPR_U32(ctx, 31, 0x1E5858u);
    ctx->pc = 0x1E5854u;
    ctx->in_delay_slot = true; ctx->branch_pc = 0x1E5850u;
            // 0x1e5854: 0x8c840000  lw          $a0, 0x0($a0) (Delay Slot)
    ...
    ctx->pc = 0x1E5858u;
    // 0x1e5858: 0xc05ba74  jal         func_16E9D0
    ctx->pc = 0x1E5858u;
    ...
    ctx->pc = 0x1E5860u;
    // 0x1e5860: 0xdfbf0010  ld          $ra, 0x10($sp)
    ctx->pc = 0x1e5860u;
    SET_GPR_U64(ctx, 31, READ64(ADD32(GPR_U32(ctx, 29), 16)));
    // 0x1e5864: 0x7bb00000  lq          $s0, 0x0($sp)
    ctx->pc = 0x1e5864u;
    SET_GPR_VEC(ctx, 16, READ128(ADD32(GPR_U32(ctx, 29), 0)));
    // 0x1e5868: 0x3e00008  jr          $ra
    ctx->pc = 0x1E5868u;
    {
        uint32_t jumpTarget = GPR_U32(ctx, 31);
        ctx->pc = 0x1E586Cu;
        ctx->in_delay_slot = true; ctx->branch_pc = 0x1E5868u;
            // 0x1e586c: 0x27bd0020  addiu       $sp, $sp, 0x20 (Delay Slot)
