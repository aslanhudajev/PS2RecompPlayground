...
void drawFlipScreen_0x105388(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    // 0x1053bc: 0x3c0d1200
    ctx->pc = 0x1053bcu;
    SET_GPR_U32(ctx, 13, ((uint32_t)4608 << 16));
    // 0x1053c0: 0x38820001
    ctx->pc = 0x1053c0u;
    ...
    // 0x1053d0: 0x3c0b1200
    ctx->pc = 0x1053d0u;
    SET_GPR_U32(ctx, 11, ((uint32_t)4608 << 16));
    // 0x1053d4: 0x3c081200
    ctx->pc = 0x1053d4u;
    ...
    // 0x1053dc: 0x356b0020
    ctx->pc = 0x1053dcu;
    SET_GPR_U32(ctx, 11, OR32(GPR_U32(ctx, 11), 32));
    // 0x1053e0: 0x852018
    ctx->pc = 0x1053e0u;
    ...
    // 0x1053e4: 0x35080070
    ctx->pc = 0x1053e4u;
    SET_GPR_U32(ctx, 8, OR32(GPR_U32(ctx, 8), 112));
    // 0x1053e8: 0x3c091200
    ctx->pc = 0x1053e8u;
    ...
    // 0x10540c: 0x34e700e0
    ctx->pc = 0x10540cu;
    SET_GPR_U32(ctx, 7, OR32(GPR_U32(ctx, 7), 224));
    // 0x105410: 0x240c0090
    ctx->pc = 0x105410u;
    ...
    // 0x1054d0: 0x34840280
    ctx->pc = 0x1054d0u;
    SET_GPR_U32(ctx, 4, OR32(GPR_U32(ctx, 4), 640));
    // 0x1054d4: 0x24030052
    ctx->pc = 0x1054d4u;
