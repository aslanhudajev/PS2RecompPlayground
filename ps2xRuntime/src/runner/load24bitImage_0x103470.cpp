...
void load24bitImage_0x103470(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    // 0x1034cc: 0x34028000
    ctx->pc = 0x1034ccu;
    SET_GPR_U64(ctx, 2, GPR_U64(ctx, 0) | (uint64_t)32768);
    // 0x1034d0: 0x2127c
    ctx->pc = 0x1034d0u;
    ...
    // 0x1034e8: 0x354a0006
    ctx->pc = 0x1034e8u;
    SET_GPR_U64(ctx, 10, GPR_U64(ctx, 10) | (uint64_t)6);
    // 0x1034ec: 0x3c021000
    ctx->pc = 0x1034ecu;
    ...
    // 0x103560: 0x35290001
    ctx->pc = 0x103560u;
    SET_GPR_U64(ctx, 9, GPR_U64(ctx, 9) | (uint64_t)1);
    // 0x103564: 0x240e0001
    ctx->pc = 0x103564u;
    ...
    // 0x10356c: 0x340c8000
    ctx->pc = 0x10356cu;
    SET_GPR_U64(ctx, 12, GPR_U64(ctx, 0) | (uint64_t)32768);
    // 0x103570: 0xc633c
    ctx->pc = 0x103570u;
    SET_GPR_U64(ctx, 12, GPR_U64(ctx, 12) << (32 + 12));
    // 0x103574: 0x3c0b3000
    ctx->pc = 0x103574u;
    SET_GPR_S32(ctx, 11, ((uint32_t)12288 << 16));
    // 0x103578: 0x25460070
    ctx->pc = 0x103578u;
