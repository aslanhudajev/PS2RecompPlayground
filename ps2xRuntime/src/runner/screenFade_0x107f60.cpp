...
void screenFade_0x107f60(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    // 0x107f94: 0x3c0701ff
    ctx->pc = 0x107f94u;
    SET_GPR_S32(ctx, 7, ((uint32_t)511 << 16));
    // 0x107f98: 0x73c38
    ctx->pc = 0x107f98u;
    SET_GPR_U64(ctx, 7, GPR_U64(ctx, 7) << 16);
    // 0x107f9c: 0x34e7027f
    ctx->pc = 0x107f9cu;
    SET_GPR_U64(ctx, 7, GPR_U64(ctx, 7) | (uint64_t)639);
    // 0x107fa0: 0x73c38
    ctx->pc = 0x107fa0u;
    SET_GPR_U64(ctx, 7, GPR_U64(ctx, 7) << 16);
    // 0x107fa4: 0xffb10010
    ...
    // 0x107fb8: 0x35290003
    ctx->pc = 0x107fb8u;
    SET_GPR_U64(ctx, 9, GPR_U64(ctx, 9) | (uint64_t)3);
    // 0x107fbc: 0xffbf0070
    ctx->pc = 0x107fbcu;
    ...
    // 0x107fd0: 0x3c0f0002
    ctx->pc = 0x107fd0u;
    SET_GPR_S32(ctx, 15, ((uint32_t)2 << 16));
    // 0x107fd4: 0x24110047
    ctx->pc = 0x107fd4u;
    ...
    // 0x107fe4: 0x3c134141
    ctx->pc = 0x107fe4u;
    SET_GPR_S32(ctx, 19, ((uint32_t)16705 << 16));
    // 0x107fe8: 0x36734141
    ctx->pc = 0x107fe8u;
    SET_GPR_U64(ctx, 19, GPR_U64(ctx, 19) | (uint64_t)16705);
    // 0x107fec: 0xaf020000
    ctx->pc = 0x107fecu;
    ...
    // 0x10800c: 0x3c0c0010
    ctx->pc = 0x10800cu;
    SET_GPR_S32(ctx, 12, ((uint32_t)16 << 16));
    // 0x108010: 0xff140038
    ctx->pc = 0x108010u;
    ...
    // 0x10802c: 0x34159400
    ctx->pc = 0x10802cu;
    SET_GPR_U64(ctx, 21, GPR_U64(ctx, 0) | (uint64_t)37888);
    // 0x108030: 0xff0f0060
    ctx->pc = 0x108030u;
    ...
    // 0x10804c: 0x340e9000
    ctx->pc = 0x10804cu;
    SET_GPR_U64(ctx, 14, GPR_U64(ctx, 0) | (uint64_t)36864);
    // 0x108050: 0xff140018
    ctx->pc = 0x108050u;
    ...
    // 0x108064: 0x3c0f7000
    ctx->pc = 0x108064u;
    SET_GPR_S32(ctx, 15, ((uint32_t)28672 << 16));
    // 0x108068: 0xaccd000c
    ctx->pc = 0x108068u;
