...
void InitAlarm_0x10ecd0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    // 0x10ecdc: 0x34421810
    ctx->pc = 0x10ecdcu;
    SET_GPR_U64(ctx, 2, GPR_U64(ctx, 2) | (uint64_t)6160);
    // 0x10ece0: 0xffb20020
    ctx->pc = 0x10ece0u;
    ...
    // 0x10ed1c: 0x3c048007
    ctx->pc = 0x10ed1cu;
    SET_GPR_S32(ctx, 4, ((uint32_t)32775 << 16));
    // 0x10ed20: 0x24a5f388
    ctx->pc = 0x10ed20u;
    SET_GPR_S32(ctx, 5, ADD32(GPR_U32(ctx, 5), 4294964104));
    // 0x10ed24: 0x34846000
    ctx->pc = 0x10ed24u;
    SET_GPR_U64(ctx, 4, GPR_U64(ctx, 4) | (uint64_t)24576);
    // 0x10ed28: 0xc043b1e
    ctx->pc = 0x10ED28u;
    ...
    // 0x10ed34: 0x3c040008
    ctx->pc = 0x10ed34u;
    SET_GPR_S32(ctx, 4, ((uint32_t)8 << 16));
    // 0x10ed38: 0x24a5fac8
    ctx->pc = 0x10ed38u;
