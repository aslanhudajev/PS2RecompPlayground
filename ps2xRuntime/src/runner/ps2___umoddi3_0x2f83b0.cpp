...
// __umoddi3(uint64 a, uint64 b): unsigned 64-bit modulo.
// MIPS O32: a in $a0:$a1 (lo:hi), b in $a2:$a3 (lo:hi)
// Returns: remainder low 32 in $v0, high 32 in $v1.
void ps2___umoddi3_0x2f83b0(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
