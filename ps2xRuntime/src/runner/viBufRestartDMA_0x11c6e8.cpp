...
void viBufRestartDMA_0x11c6e8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    // 0x11c748: 0x34b30100
    ctx->pc = 0x11c748u;
    SET_GPR_U64(ctx, 19, GPR_U64(ctx, 5) | (uint64_t)256);
    // 0x11c74c: 0xc0438b8
    ctx->pc = 0x11C74Cu;
    ...
    ctx->pc = 0x11C75Cu;
    {
        ...
        ctx->pc = 0x11C760u;
        SET_GPR_S32(ctx, 8, ((uint32_t)4095 << 16));
    ...
    // 0x11c774: 0x3508ffff
    ctx->pc = 0x11c774u;
    SET_GPR_U64(ctx, 8, GPR_U64(ctx, 8) | (uint64_t)65535);
    // 0x11c778: 0x8e09001c
    ctx->pc = 0x11c778u;
...
label_11c7b4:
    ...
    ctx->pc = 0x11C7C8u;
    {
        ...
        ctx->pc = 0x11C7CCu;
        SET_GPR_U64(ctx, 19, GPR_U64(ctx, 3) | (uint64_t)256);
...
label_11c808:
    ...
    ctx->pc = 0x11C828u;
    {
        ...
        ctx->pc = 0x11C82Cu;
        SET_GPR_S32(ctx, 9, ((uint32_t)4095 << 16));
...
label_11c84c:
    ...
    ctx->pc = 0x11C8C4u;
    {
        ...
        ctx->pc = 0x11C8C8u;
        SET_GPR_U64(ctx, 19, GPR_U64(ctx, 4) | (uint64_t)256);
...
label_11c8f0:
    ...
    ctx->pc = 0x11C924u;
    SET_GPR_U64(ctx, 4, GPR_U64(ctx, 4) | (uint64_t)256);
    ctx->pc = 0x11C008u;
    {
        const uint32_t __entryPc = ctx->pc;
...
label_11c984:
    ...
    // 0x11c990: 0x3484b430
    ctx->pc = 0x11c990u;
    SET_GPR_U64(ctx, 4, GPR_U64(ctx, 4) | (uint64_t)46128);
    // 0x11c994: 0xac720000
    ctx->pc = 0x11c994u;
