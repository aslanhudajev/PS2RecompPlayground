...
// Ghidra: env+8=innerPtr, env+12=mask. Mask bit 2 -> slot. RMW LSB: old & ~1 | (a1 & 1).
void sceHiGsEnvSetRegDthe_0x114ad8(uint8_t* rdram, R5900Context* ctx, PS2Runtime* runtime) {
#ifdef _DEBUG
    PS_LOG_ENTRY("sceHiGsEnvSetRegDthe_0x114ad8");
#endif
    ...
    constexpr uint32_t kBitIndex = 2u;
