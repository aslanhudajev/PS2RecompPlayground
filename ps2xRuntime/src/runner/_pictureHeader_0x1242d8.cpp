...
void _pictureHeader_0x1242d8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
    ...
    // 0x124318: 0x8e43197c
    ctx->pc = 0x124318u;
    SET_GPR_U32(ctx, 3, READ32(ADD32(GPR_U32(ctx, 18), 6524)));
    // 0x12431c: 0xae021980
    ctx->pc = 0x12431cu;
    ...
    ctx->pc = 0x124328u;
    {
        const bool branch_taken_0x124328 = (GPR_U32(ctx, 2) == GPR_U32(ctx, 0));
        ctx->pc = 0x12432Cu;
...
label_124358:
    ...
    ctx->pc = 0x124358u;
    {
        const bool branch_taken_0x124358 = (GPR_U32(ctx, 3) != GPR_U32(ctx, 2));
        ctx->pc = 0x12435Cu;
        SET_GPR_S32(ctx, 4, ADD32(GPR_U32(ctx, 0), 1));
