...
label_102d68:
    ...
    // 0x102db4: 0x3c0bf3ff
    ctx->pc = 0x102db4u;
    SET_GPR_U32(ctx, 11, ((uint32_t)62463 << 16));
    // 0x102db8: 0x356bffff
    ctx->pc = 0x102db8u;
    ...
    // 0x102ea8: 0x7e1825
    ctx->pc = 0x102ea8u;
    SET_GPR_U32(ctx, 3, OR32(GPR_U32(ctx, 3), GPR_U32(ctx, 30)));
    // 0x102eac: 0xc83025
    ctx->pc = 0x102eacu;
    SET_GPR_U32(ctx, 6, OR32(GPR_U32(ctx, 6), GPR_U32(ctx, 8)));
    // 0x102eb0: 0x651825
    ctx->pc = 0x102eb0u;
    ...
    // 0x102ecc: 0xcf3025
    ctx->pc = 0x102eccu;
    SET_GPR_U32(ctx, 6, OR32(GPR_U32(ctx, 6), GPR_U32(ctx, 15)));
    // 0x102ed0: 0x304207ff
    ctx->pc = 0x102ed0u;
    SET_GPR_U32(ctx, 2, AND32(GPR_U32(ctx, 2), 2047));
    // 0x102ed4: 0x2405ff7f
    ...
    // 0x102ed8: 0x3c11ff80
    ctx->pc = 0x102ed8u;
    SET_GPR_U32(ctx, 17, ((uint32_t)65408 << 16));
    // 0x102edc: 0x36310fff
    ctx->pc = 0x102edcu;
    SET_GPR_U32(ctx, 17, OR32(GPR_U32(ctx, 17), 4095));
    // 0x102ee0: 0x118c38
    ctx->pc = 0x102ee0u;
    ...
    // 0x102ef4: 0xee3825
    ctx->pc = 0x102ef4u;
    SET_GPR_U32(ctx, 7, OR32(GPR_U32(ctx, 7), GPR_U32(ctx, 14)));
    // 0x102ef8: 0x2133c
    ctx->pc = 0x102ef8u;
    ...
    // 0x102f08: 0x3c09ffc0
    ctx->pc = 0x102f08u;
    SET_GPR_U32(ctx, 9, ((uint32_t)65472 << 16));
    // 0x102f0c: 0x352907ff
    ctx->pc = 0x102f0cu;
    SET_GPR_U32(ctx, 9, OR32(GPR_U32(ctx, 9), 2047));
    // 0x102f10: 0x94c38
    ctx->pc = 0x102f10u;
    ...
    // 0x102f40: 0x16e5825
    ctx->pc = 0x102f40u;
    SET_GPR_U32(ctx, 11, OR32(GPR_U32(ctx, 11), GPR_U32(ctx, 14)));
    // 0x102f44: 0x34088000
    ctx->pc = 0x102f44u;
    ...
    // 0x102f64: 0x3c0e0014
    ctx->pc = 0x102f64u;
    SET_GPR_U32(ctx, 14, ((uint32_t)20 << 16));
    // 0x102f68: 0xfd4d0028
    ctx->pc = 0x102f68u;
    WRITE64(ADD32(GPR_U32(ctx, 10), 40), GPR_U64(ctx, 13));
    // 0x102f6c: 0x1896025
    ctx->pc = 0x102f6cu;
    SET_GPR_U32(ctx, 12, OR32(GPR_U32(ctx, 12), GPR_U32(ctx, 9)));
    // 0x102f70: 0x25ce14f0
    ctx->pc = 0x102f70u;
...
// In recompiled code, we don't need explicit memory barriers
    ...
    // 0x103020: 0x3c081200
    ctx->pc = 0x103020u;
    SET_GPR_U32(ctx, 8, ((uint32_t)4608 << 16));
    // 0x103024: 0x972018
    ctx->pc = 0x103024u;
    ...
    // 0x103028: 0x35080020
    ctx->pc = 0x103028u;
    SET_GPR_U32(ctx, 8, OR32(GPR_U32(ctx, 8), 32));
    // 0x10302c: 0x3c061200
    ctx->pc = 0x10302cu;
    SET_GPR_U32(ctx, 6, ((uint32_t)4608 << 16));
    // 0x103030: 0x3c091200
    ctx->pc = 0x103030u;
    SET_GPR_U32(ctx, 9, ((uint32_t)4608 << 16));
    // 0x103034: 0x34c60070
    ctx->pc = 0x103034u;
    SET_GPR_U32(ctx, 6, OR32(GPR_U32(ctx, 6), 112));
    // 0x103038: 0x35290090
    ctx->pc = 0x103038u;
    SET_GPR_U32(ctx, 9, OR32(GPR_U32(ctx, 9), 144));
    // 0x10303c: 0x3c071200
    ctx->pc = 0x10303cu;
    SET_GPR_U32(ctx, 7, ((uint32_t)4608 << 16));
    // 0x103040: 0x3c0a1200
    ctx->pc = 0x103040u;
    SET_GPR_U32(ctx, 10, ((uint32_t)4608 << 16));
    // 0x103044: 0x822021
    ctx->pc = 0x103044u;
    SET_GPR_U32(ctx, 4, ADD32(GPR_U32(ctx, 4), GPR_U32(ctx, 2)));
    // 0x103048: 0x34e70080
    ctx->pc = 0x103048u;
    SET_GPR_U32(ctx, 7, OR32(GPR_U32(ctx, 7), 128));
    // 0x10304c: 0xdc820000
    ctx->pc = 0x10304cu;
    SET_GPR_U64(ctx, 2, READ64(ADD32(GPR_U32(ctx, 4), 0)));
    // 0x103050: 0x354a00a0
    ctx->pc = 0x103050u;
    SET_GPR_U32(ctx, 10, OR32(GPR_U32(ctx, 10), 160));
    // 0x103054: 0x3c051200
    ctx->pc = 0x103054u;
    ...
    // 0x103060: 0x34a500e0
    ctx->pc = 0x103060u;
    SET_GPR_U32(ctx, 5, OR32(GPR_U32(ctx, 5), 224));
    // 0x103064: 0x3c0c0014
    ctx->pc = 0x103064u;
    SET_GPR_U32(ctx, 12, ((uint32_t)20 << 16));
    // 0x103068: 0xdc820008
    ctx->pc = 0x103068u;
