...
label_12c590:
    if (ctx->pc == 0x12C590u) {
        ctx->pc = 0x12C590u;
        SET_GPR_U64(ctx, 30, GPR_U64(ctx, 30) | (uint64_t)4);
        ctx->pc = 0x12C594u;
        goto label_12c594;
    }
    ctx->pc = 0x12C58Cu;
...
label_12c63c:
    if (ctx->pc == 0x12C63Cu) {
        ctx->pc = 0x12C63Cu;
        SET_GPR_U64(ctx, 30, GPR_U64(ctx, 30) | (uint64_t)128);
        ctx->pc = 0x12C640u;
        goto label_12c640;
    }
    ctx->pc = 0x12C638u;
...
label_12c67c:
    // 0x12c67c: 0x37de0008
    ctx->pc = 0x12c67cu;
    SET_GPR_U64(ctx, 30, GPR_U64(ctx, 30) | (uint64_t)8);
label_12c680:
    // 0x12c680: 0x1000ffa2
label_12c684:
    if (ctx->pc == 0x12C684u) {
...
label_12c68c:
    // 0x12c68c: 0x37de0040
    ctx->pc = 0x12c68cu;
    SET_GPR_U64(ctx, 30, GPR_U64(ctx, 30) | (uint64_t)64);
label_12c690:
    // 0x12c690: 0x1000ff9e
label_12c694:
    if (ctx->pc == 0x12C694u) {
...
label_12c6b4:
    // 0x12c6b4: 0x37de0020
    ctx->pc = 0x12c6b4u;
    SET_GPR_U64(ctx, 30, GPR_U64(ctx, 30) | (uint64_t)32);
label_12c6b8:
    // 0x12c6b8: 0xafa501ec
    ctx->pc = 0x12c6b8u;
...
label_12c6c8:
    if (ctx->pc == 0x12C6C8u) {
        ctx->pc = 0x12C6C8u;
        SET_GPR_U64(ctx, 30, GPR_U64(ctx, 30) | (uint64_t)16);
        ctx->pc = 0x12C6CCu;
        goto label_12c6cc;
    }
    ctx->pc = 0x12C6C4u;
...
label_12c7e4:
    // 0x12c7e4: 0x37de0100
    ctx->pc = 0x12c7e4u;
    SET_GPR_U64(ctx, 30, GPR_U64(ctx, 30) | (uint64_t)256);
label_12c7e8:
    // 0x12c7e8: 0x8fa401e4
    ctx->pc = 0x12c7e8u;
...
label_12c9a4:
    // 0x12c9a4: 0x37de0002
    ctx->pc = 0x12c9a4u;
    SET_GPR_U64(ctx, 30, GPR_U64(ctx, 30) | (uint64_t)2);
label_12c9a8:
    // 0x12c9a8: 0x24170078
    ctx->pc = 0x12c9a8u;
...
label_12ca90:
    // 0x12ca90: 0x37c20002
    ctx->pc = 0x12ca90u;
    SET_GPR_U64(ctx, 2, GPR_U64(ctx, 30) | (uint64_t)2);
label_12ca94:
    // 0x12ca94: 0x50f00b
    ctx->pc = 0x12ca94u;
