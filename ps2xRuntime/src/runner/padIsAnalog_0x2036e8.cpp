...
// padIsAnalog(int param_1) - reads aiPadType[param_1], returns 1 if analog type
// aiPadType @ 0x3BBDA0, analog types: 2, 3, or 5
void padIsAnalog_0x2036e8(uint8_t* rdram, R5900Context* ctx, PS2Runtime *runtime) {
